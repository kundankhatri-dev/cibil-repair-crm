<?php
// ============================================================
// CIBIL REPAIR CRM - Export Leads API (All Formats)
// Endpoint: /api/export_leads.php
// Method: GET
// ============================================================
...
if (empty($leads)) {
    ob_clean();
    echo json_encode(['success' => false, 'error' => 'No leads found to export']);
    exit();
}
...
switch ($format) {
    ...
    case 'json':
        exportJSON($processedLeads, $filename);
        break;
