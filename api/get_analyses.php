<?php
// ============================================================
// CIBIL REPAIR CRM - Get Document Analyses API (FIXED)
// ============================================================
...
$columns = getTableColumns($conn, 'document_analyses');

// Define columns we want to select (only those that exist)
$desiredColumns = ['id', 'user_id', 'document_type', 'filename', 'analysis_result', 'status', 'created_at'];
$selectedColumns = array_intersect($desiredColumns, $columns);

// If no columns found, use minimal set
if (empty($selectedColumns)) {
    $selectedColumns = ['id', 'filename', 'document_type', 'created_at'];
}
...
$query = "SELECT $selectClause FROM document_analyses $whereClause ORDER BY created_at DESC LIMIT ? OFFSET ?";
