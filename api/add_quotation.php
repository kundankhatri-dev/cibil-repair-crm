...
// ============================================================
# CREATE QUOTATIONS TABLE (drop and recreate with correct columns)
// ============================================================

// Drop old table if exists
mysqli_query($conn, "DROP TABLE IF EXISTS quotations");

// Create new table with correct columns
$createTable = "CREATE TABLE quotations (
...
if (!$createResult) {
    echo json_encode(['success' => false, 'error' => 'Failed to create table: ' . mysqli_error($conn)]);
    exit;
}
