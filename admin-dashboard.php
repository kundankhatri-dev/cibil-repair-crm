...
// Add CSS for admin clickable labels
...
adminStyle.textContent = `
    ...
    label[for]:hover .text-danger,
    label[for]:hover .required {
...
<div class="main">
  ...
  <div class="content">
    ...
    <div class="section" id="partnerListSection">
        <div class="card">
            <div class="card-header">
                ...
                <div class="gap-8">
                    <!-- AUTO-GENERATE PARTNER BUTTON -->
                    <a href="api/partner/add_partner_auto.php" class="btn btn-primary btn-sm" target="_blank">
                        <i class="fas fa-magic"></i> Auto-Generate
                    </a>
                    <button class="btn btn-success btn-sm" onclick="showSection('addPartner')">
    ...
    <div class="modal-overlay" id="approvePartnerModal">
        <div class="modal-box" style="max-width:550px;">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="form-label" for="sendWhatsApp">
    ...
    <!-- ============================================================ -->
    <!-- EDIT PARTNER MODAL (with Tier & Toggles)                     -->
    <!-- ============================================================ -->
    <div class="modal-overlay" id="editPartnerModal">
        <div class="modal-box">
            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label class="form-label" for="editPartnerName">Business Name <span class="form-req">*</span></label>
                        <input class="form-input" id="editPartnerName" placeholder="Business Name">
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="editPartnerOwner">Owner Name</label>
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label class="form-label" for="editPartnerPhone">Phone <span class="form-req">*</span></label>
                        <input class="form-input" id="editPartnerPhone" placeholder="Phone Number" maxlength="10">
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="editPartnerLoc">Location</label>
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label class="form-label" for="editPartnerComm">Commission Rate (%)</label>
                        <input class="form-input" id="editPartnerComm" type="number" value="10" min="0" max="100">
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="editPartnerStatus">Status</label>
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label class="form-label" for="editPartnerTier">Tier</label>
                    ...
                    <div class="form-group">
                        <!-- Empty placeholder to keep two‑column layout -->
                    </div>
                </div>

                <!-- Allow Payouts & Allow Referrals -->
                <div class="form-row">
                    <div class="form-group">
                        <label class="form-label" for="editPartnerAllowPayouts" style="font-weight:normal;">
                            <input type="checkbox" id="editPartnerAllowPayouts" checked value="1"> 
                            Allow Payouts
                        </label>
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="editPartnerAllowReferrals" style="font-weight:normal;">
                            <input type="checkbox" id="editPartnerAllowReferrals" checked value="1"> 
                            Allow Referrals
                        </label>
                    </div>
                </div>
    ...
    <!-- ============================================================ -->
    <!-- MANAGE PARTNER MODAL (Advanced Controls + Stats)             -->
    <!-- ============================================================ -->
    <div class="modal-overlay" id="managePartnerModal">
      <div class="modal-box" style="max-width:750px;">
        <div class="modal-header">
          <span class="modal-title"><i class="fas fa-user-cog"></i> Manage Partner</span>
          <button class="modal-close" onclick="closeModal('managePartnerModal')"><i class="fas fa-times"></i></button>
        </div>
        <div class="modal-body">
          <input type="hidden" id="managePartnerId">

          <!-- Stats & Controls Row -->
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:16px;">
            <div>
              <h4 style="font-size:14px;font-weight:700;margin-bottom:6px;">📊 Performance</h4>
              <div style="font-size:13px;color:var(--text-secondary);">
                <div>Total Leads:  <strong id="mLeads" style="color:var(--text-primary);">—</strong></div>
                <div>Converted:    <strong id="mConverted" style="color:var(--text-primary);">—</strong></div>
                <div>Commission:   <strong id="mCommission" style="color:var(--brand-dark);">—</strong></div>
              </div>
            </div>
            <div>
              <h4 style="font-size:14px;font-weight:700;margin-bottom:6px;">⚙️ Controls</h4>
              <div class="form-row" style="margin-bottom:6px;">
                ...
                <div class="form-group">
                  ...
                  <input class="form-input" id="mCommissionRate" type="number" min="0" max="100" value="10">
                </div>
              </div>
              <div style="display:flex;gap:16px;flex-wrap:wrap;font-size:13px;">
                <label for="mAllowPayouts"><input type="checkbox" id="mAllowPayouts" checked> Allow Payouts</label>
                <label for="mAllowReferrals"><input type="checkbox" id="mAllowReferrals" checked> Allow Referrals</label>
              </div>
            </div>
          </div>
          ...
          <div class="form-row">
            <div class="form-group">
              ...
              <input class="form-input" id="mName" placeholder="Business Name">
            </div>
            <div class="form-group">
              <label class="form-label">Phone</label>
              <input class="form-input" id="mPhone" placeholder="Phone">
            </div>
          </div>
          <div class="form-row">
            <div class="form-group">
              <label class="form-label">Location</label>
              <input class="form-input" id="mLocation" placeholder="Location">
            </div>
            <div class="form-group">
              <label class="form-label">Status</label>
        ...
        <div class="modal-footer">
          <button class="btn btn-ghost" onclick="closeModal('managePartnerModal')">Cancel</button>
          <button class="btn btn-primary" onclick="saveManagePartner()"><i class="fas fa-save"></i> Save Changes</button>
        </div>
      </div>
    </div>
    ...
    <div class="section" id="bankListSection">
        <div class="card">
            <div class="card-header">
                <div class="card-title">
                    <i class="fas fa-university"></i> Bank List
                </div>
                <div class="gap-8">
                    ...
                    <button class="btn btn-primary btn-sm" onclick="showSection('addBank')">
            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                    <div class="form-group" style="flex:1;">
                        <label class="form-label" for="newServiceFeatured">
                            <input type="checkbox" id="newServiceFeatured" value="1"> 
                            Feature this service
                        </label>
                    </div>
                    <div class="form-group" style="flex:1;">
                        <label class="form-label" for="newServicePopular">
    ...
    <div class="modal-overlay" id="editServiceModal">
        <div class="modal-box" style="max-width:600px;">
            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                    <div class="form-group" style="flex:1;">
                        <label class="form-label" for="editServiceFeatured">
                            <input type="checkbox" id="editServiceFeatured" value="1"> 
                            Feature this service
                        </label>
                    </div>
                    <div class="form-group" style="flex:1;">
                        <label class="form-label" for="editServicePopular">
...
function debounceFilter(target) {
  ...
  debounceTimeout = setTimeout(() => {
    switch (target) {
      ...
      case 'services':  servicePage = 1; renderServices(); break;
...
function toggleDashboards() {
  ...
  var body = document.getElementById('dashboardGridBody');
  var icon = document.getElementById('collapseIcon');
  if (body) {
    body.style.display = _dashCollapsed ? 'none' : 'block';
  }
  if (icon) {
    icon.classList.toggle('rotated', _dashCollapsed);
  }
  localStorage.setItem('dashGridCollapsed', _dashCollapsed ? '1' : '0');
}

// =============================================
// FORCE DASHBOARD CARD TO BE VISIBLE ON LOAD
// =============================================
(function() {
  // Always start with card expanded
  ...
  // Remove rotated class from icon
  if (icon) {
    icon.classList.remove('rotated');
  }
  
  // REMOVE the stored value so it doesn't persist
  try {
    localStorage.removeItem('dashGridCollapsed');
  } catch(e) {
    // Ignore errors
  }
  
  console.log('✅ Dashboard card forced visible');
})();
...
function showSection(name) {
  ...
  const loaders = {
    dashboard: () => { if (document.getElementById('salesChart')) initCharts(); refreshActivity(); },
    decisionHub: () => { if (document.getElementById('revenueTargetChart')) initDecisionCharts(); },
    leads: () => { if (document.getElementById('leadsBody')) loadLeads(); },
    customerList: () => { if (document.getElementById('customerTableBody')) renderCustomers(); },
    partnerList: () => { if (document.getElementById('partnerTableBody')) renderPartners(); },
    bankList: () => { if (document.getElementById('bankTableBody')) renderBanks(); },
    quotationList: () => { if (document.getElementById('quoteBody')) renderQuotations(); },
    customerRequests: () => { if (document.getElementById('reqTableBody')) renderRequests(); },
    activityLog: () => { if (document.getElementById('logBody')) loadActivityLog(); },
    backup: () => { if (document.getElementById('backupBody')) loadBackups(); },
    codeList: () => { if (document.getElementById('codeListBody')) loadCodeList(); },
    usersByCode: () => { if (document.getElementById('usersByCodeBody')) loadUsersByCode(); },
    aiAnalyzer: () => { if (document.getElementById('analysisHistory')) loadAnalysisHistory(); },
    txHistory: () => { if (document.getElementById('txBody')) loadTransactions(); },
    expenseReport: () => { if (document.getElementById('expRepBody')) generateExpenseReport(); },
    posters: () => { if (document.getElementById('posterGrid')) loadPosters(); },
    partnerApplications: () => { loadPartnerApplications(); },
    reviews: () => { if (document.getElementById('reviewsContainer')) loadReviews('reviewsContainer'); },
    services: () => { if (document.getElementById('servicesContainer')) loadServices('servicesContainer'); },
    addCustomer: () => {},
    addPartner: () => {},
    addBank: () => {},
    addSale: () => {},
...
/* ============================================================
   SERVICES MODULE – SINGLE, CLEAN DEFINITION
   ============================================================ */
...
function getDemoServices() {
    return [
        { id: 1, name: 'CIBIL Score Repair', category: 'credit_repair',
          description: 'Complete credit score repair service.', price: 999,
          duration: '30-45 days', icon: '📈', status: 'active',
          is_featured: 1, is_popular: 1 },
        { id: 2, name: 'Dispute Resolution', category: 'dispute',
          description: 'Professional dispute filing service.', price: 1499,
          duration: '15-20 days', icon: '⚖️', status: 'active',
          is_featured: 1, is_popular: 0 },
        { id: 3, name: 'Credit Consultation', category: 'consulting',
          description: 'One-on-one consultation with credit experts.', price: 499,
          duration: '1-2 days', icon: '💡', status: 'active',
          is_featured: 0, is_popular: 1 },
        { id: 4, name: 'Legal Credit Protection', category: 'legal',
          description: 'Legal protection services for credit-related disputes.', price: 2499,
          duration: '60-90 days', icon: '🏛️', status: 'inactive',
          is_featured: 0, is_popular: 0 },
        { id: 5, name: 'Financial Planning', category: 'financial',
          description: 'Comprehensive financial planning service.', price: 1999,
          duration: '45-60 days', icon: '💰', status: 'draft',
          is_featured: 0, is_popular: 0 }
    ].map(function(s) {
        s.formatted_date = new Date().toLocaleDateString('en-IN', { day:'numeric', month:'short', year:'numeric' });
        return s;
    });
}
...
async function loadServices(containerId) {
    containerId = containerId || 'servicesContainer';
    ...
    try {
        var res = await fetch('api/fetch_services.php?_=' + Date.now());
    ...
    if (typeof state !== 'undefined') state.services = servicesData;
...
function renderServices(containerId) {
    ...
    var catFilter = document.getElementById('serviceCategoryFilter')?.value || '';
    var statusFilter = document.getElementById('serviceStatusFilter')?.value || '';

    var filtered = servicesData.filter(function(s) {
        var matchSearch = !search ||
            (s.name || '').toLowerCase().includes(search) ||
            (s.description || '').toLowerCase().includes(search) ||
            (s.category || '').toLowerCase().includes(search);
        var matchCat = !catFilter || (s.category || '') === catFilter;
    ...
    var totalEl = document.getElementById('serviceTotal');
    ...
    var countEl = document.getElementById('serviceTotalCount');
        ...
        container.innerHTML = `
            <div class="empty-state">
                ...
                <div class="empty-state-title">
                    ${search || catFilter || statusFilter ? 'No services match your filters' : 'No services yet'}
                </div>
                <div class="empty-state-sub">
                    ${search || catFilter || statusFilter ? 'Try adjusting your filters' : 'Click "Add Service" to create your first service'}
                </div>
            </div>
        `;
        return;
    ...
    container.innerHTML = pageData.map(function(s) {
        ...
        var statusLabel = s.status ? s.status.charAt(0).toUpperCase() + s.status.slice(1) : 'Active';
        var priceDisplay = '₹' + Number(s.price || 0).toLocaleString('en-IN');
        var categoryLabel = categoryLabels[s.category] || s.category || 'Other';
        var formattedDate = s.formatted_date || (s.created_at ? new Date(s.created_at).toLocaleDateString('en-IN') : '');
        ...
        return `
            <div class="service-card" style="border:1px solid var(--border);border-radius:var(--r-md);padding:16px;margin-bottom:12px;background:var(--bg-surface);transition:all 0.2s;position:relative;">
                ${s.is_featured ? '<span style="position:absolute;top:8px;right:8px;font-size:11px;background:var(--brand-light);color:var(--brand-dark);padding:2px 10px;border-radius:99px;font-weight:700;">⭐ Featured</span>' : ''}
                ${s.is_popular && !s.is_featured ? '<span style="position:absolute;top:8px;right:8px;font-size:11px;background:var(--warning-bg);color:var(--warning-text);padding:2px 10px;border-radius:99px;font-weight:700;">🔥 Popular</span>' : ''}
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;flex-wrap:wrap;gap:8px;">
                    <div style="display:flex;align-items:center;gap:12px;">
                        <span style="font-size:32px;">${esc(s.icon || '⭐')}</span>
                        <div>
                            <strong style="font-size:16px;">${esc(s.name)}</strong>
                            <span class="badge badge-blue" style="font-size:9px;margin-left:6px;">${esc(categoryLabel)}</span>
                        </div>
                    </div>
                    <div style="text-align:right;">
                        <div style="font-size:20px;font-weight:700;color:var(--brand-dark);">${priceDisplay}</div>
                        <div style="font-size:11px;color:var(--text-muted);">${esc(s.duration || '30-45 days')}</div>
                    </div>
                </div>
                <p style="font-size:13px;color:var(--text-secondary);line-height:1.5;margin:8px 0 12px 0;">${esc(s.description || '')}</p>
                <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px;">
                    <div>
                        <span class="badge ${statusClass}">${esc(statusLabel)}</span>
                        <span style="font-size:11px;color:var(--text-muted);margin-left:8px;">${esc(formattedDate)}</span>
                    </div>
                    <div class="gap-8">
                        <button class="btn btn-ghost btn-xs" onclick="editService(${s.id})" title="Edit">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="btn btn-${s.status === 'active' ? 'warning' : 'success'} btn-xs" onclick="toggleServiceStatus(${s.id})" title="${s.status === 'active' ? 'Deactivate' : 'Activate'}">
...
function changeServicePage(direction) {
    var maxPage = Math.ceil(servicesData.length / servicePerPage) || 1;
...
function showAddServiceModal() {
    ['newServiceName', 'newServiceDescription', 'newServicePrice', 'newServiceIcon'].forEach(function(id) {
        var el = document.getElementById(id);
        if (el) el.value = '';
    });
    document.getElementById('newServiceCategory').value = 'credit_repair';
    document.getElementById('newServiceDuration').value = '30-45 days';
    document.getElementById('newServiceStatus').value = 'active';
    document.getElementById('newServiceFeatured').checked = false;
    document.getElementById('newServicePopular').checked = false;
...
async function submitService() {
    ...
    if (!name) { toast('Service name is required', 'error'); document.getElementById('newServiceName').focus(); return; }
    if (!description) { toast('Description is required', 'error'); document.getElementById('newServiceDescription').focus(); return; }
    if (!price || price <= 0) { toast('Please enter a valid price', 'error'); document.getElementById('newServicePrice').focus(); return; }

    var btn = document.querySelector('#addServiceModal .btn-primary');
    var orig = btn?.innerHTML || 'Save Service';
    if (btn) { btn.disabled = true; btn.innerHTML = '<span class="spinner"></span> Saving...'; }

    try {
        var res = await fetch('api/add_service.php', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ name: name, description: description, price: price, category: category, duration: duration, icon: icon, status: status, is_featured: isFeatured, is_popular: isPopular })
        });
        var data = await res.json();
        if (data.success) {
            ...
            await loadServices();
            addActivityEntry('Service Added', name);
        } else {
...
async function updateService() {
    ...
    var orig = btn?.innerHTML || 'Update Service';
    if (btn) { btn.disabled = true; btn.innerHTML = '<span class="spinner"></span> Updating...'; }

    try {
        var res = await fetch('api/update_service.php', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ id: id, name: name, description: description, price: price, category: category, duration: duration, icon: icon, status: status, is_featured: isFeatured, is_popular: isPopular })
        });
        var data = await res.json();
        if (data.success) {
            ...
            await loadServices();
            addActivityEntry('Service Updated', name);
        } else {
...
async function confirmDeleteService() {
    ...
    try {
        var res = await fetch('api/delete_service.php', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
function exportServices(format) {
    ...
    var url = 'api/export_services.php?format=' + format + '&_=' + Date.now();
...
document.addEventListener('click', function(e) {
    var dropdown = document.getElementById('servicesExportDropdown');
    if (dropdown && !e.target.closest('.gap-8')) dropdown.style.display = 'none';
});
...
if (typeof window !== 'undefined') {
    ...
    window.toggleServicesExportDropdown = toggleServicesExportDropdown;
    ...
    window.getDemoServices = getDemoServices;
...
function loadCustomers() {
    ...
    if (!tbody) {
        console.warn('customerTableBody not found');
        return;
    }
    
    tbody.innerHTML = `<tr><td colspan="8"><div class="loading-cell"><div class="spinner"></div></div></td></tr>`;
    
    try {
        const customers = state.customers || [];
        if (customers.length === 0) {
            tbody.innerHTML = `<tr><td colspan="8"><div class="empty-state"><div class="empty-state-icon"><i class="fas fa-users"></i></div><div class="empty-state-title">No customers found</div></div></td></tr>`;
            return;
        }
        ...
        tbody.innerHTML = customers.map((c, i) => `
            <tr>
                ...
                <td>${c.joined ? new Date(c.joined).toLocaleDateString('en-IN') : '—'}</td>
                <td>
                    <div class="gap-8">
                        <button class="btn btn-ghost btn-xs" onclick="editCustomer(${c.id})"><i class="fas fa-edit"></i></button>
        ...
        tbody.innerHTML = `<tr><td colspan="8"><div class="empty-state"><i class="fas fa-exclamation-triangle"></i><p>Error loading customers</p></div></td></tr>`;
    }
}
...
function renderPartners() {
    ...
    tbody.innerHTML = filtered.map((p, i) => {
        ...
        const partnerId = p.id || p.partner_id || p.user_id;
        ...
        return `<tr>
            ...
            <td>
                <div class="gap-8">
                    <!-- VIEW PARTNER PORTAL BUTTON - ADD THIS -->
                    <button class="btn btn-info btn-xs" 
                            onclick="window.open('partner-dashboard.php?user_id=${partnerId}&admin_view=1', '_blank')" 
                            title="View Partner Portal">
                        <i class="fas fa-eye"></i>
                    </button>
                    <button class="btn btn-primary btn-xs" onclick="openManagePartner(${partnerId})" title="Manage Partner">
...
function editPartner(id) {
    ...
    if (!p) { toast('Partner not found', 'error'); return; }
    ...
    document.getElementById('editPartnerTier').value = p.tier || '1';
    document.getElementById('editPartnerAllowPayouts').checked = (p.allow_payouts == 1);
    document.getElementById('editPartnerAllowReferrals').checked = (p.allow_referrals == 1);
...
function saveEditPartner() {
    ...
    const tier = parseInt(document.getElementById('editPartnerTier').value) || 1;
    const allowPayouts = document.getElementById('editPartnerAllowPayouts').checked ? 1 : 0;
    const allowReferrals = document.getElementById('editPartnerAllowReferrals').checked ? 1 : 0;
    
    if (!name) { toast('Partner name is required', 'error'); return; }
    if (!phone) { toast('Phone is required', 'error'); return; }
    if (!validatePhone(phone)) { toast('Enter a valid 10-digit phone number', 'error'); return; }
    
    const data = {
        id, name, owner, phone, location, commission_rate: commission, status,
        tier, allow_payouts: allowPayouts, allow_referrals: allowReferrals
    };
    ...
    .then(data => {
        if (data.success) {
            ...
            if (idx !== -1) {
                state.partners[idx] = { ...state.partners[idx], ...data.partner || data };
                renderPartners();
            }
...
// ============================================================
// OPEN MANAGE PARTNER MODAL
// ============================================================
async function openManagePartner(id) {
    const modal = document.getElementById('managePartnerModal');
    document.getElementById('managePartnerId').value = id;
    
    document.getElementById('mLeads').textContent = '…';
    document.getElementById('mConverted').textContent = '…';
    document.getElementById('mCommission').textContent = '…';
    
    try {
        const data = await apiFetch(API + 'get_partner_details.php?id=' + id);
        if (data && data.success) {
            ...
            document.getElementById('mLocation').value = p.location || '';
            document.getElementById('mStatus').value = p.status || 'active';
            
            document.getElementById('mTier').value = p.tier || '1';
            document.getElementById('mCommissionRate').value = p.commission_rate || 10;
            document.getElementById('mAllowPayouts').checked = (p.allow_payouts == 1);
            document.getElementById('mAllowReferrals').checked = (p.allow_referrals == 1);
            
            document.getElementById('mLeads').textContent = s.total_leads || 0;
            document.getElementById('mConverted').textContent = s.converted_leads || 0;
            document.getElementById('mCommission').textContent = '₹' + (s.total_commission || 0).toLocaleString('en-IN');
            
            openModal('managePartnerModal');
        } else {
            console.warn('API failed, using local state');
            const partner = state.partners.find(p => (p.id || p.partner_id || p.user_id) == id);
            if (partner) {
                document.getElementById('mName').value = partner.name || '';
                document.getElementById('mPhone').value = partner.phone || '';
                document.getElementById('mLocation').value = partner.location || '';
                document.getElementById('mStatus').value = partner.status || 'active';
                document.getElementById('mTier').value = partner.tier || '1';
                document.getElementById('mCommissionRate').value = partner.commission_rate || 10;
                document.getElementById('mAllowPayouts').checked = (partner.allow_payouts == 1);
                document.getElementById('mAllowReferrals').checked = (partner.allow_referrals == 1);
                document.getElementById('mLeads').textContent = 'N/A';
                document.getElementById('mConverted').textContent = 'N/A';
                document.getElementById('mCommission').textContent = 'N/A';
                openModal('managePartnerModal');
                toast('Loaded partner data from cache', 'info');
                return;
            } else {
                toast('Partner not found in local data', 'error');
                return;
            }
        }
    } catch (e) {
        console.error(e);
        toast('Error loading partner data', 'error');
    }
}

// ============================================================
// SAVE MANAGE PARTNER CHANGES
// ============================================================
async function saveManagePartner() {
    const id = document.getElementById('managePartnerId').value;
    const data = {
        id: parseInt(id),
        ...
        commission_rate: parseFloat(document.getElementById('mCommissionRate').value),
        allow_payouts: document.getElementById('mAllowPayouts').checked ? 1 : 0,
        allow_referrals: document.getElementById('mAllowReferrals').checked ? 1 : 0
    };
    
    const btn = document.querySelector('#managePartnerModal .btn-primary');
    const orig = btn.innerHTML;
    btn.disabled = true;
    btn.innerHTML = '<span class="spinner"></span> Saving…';
    
    try {
        const res = await apiFetch(API + 'update_partner_controls.php', {
            method: 'POST',
            body: JSON.stringify(data)
        });
        if (res && res.success) {
            toast('Partner updated successfully!', 'success');
            closeModal('managePartnerModal');
            renderPartners();
        } else {
...
function renderReviews(reviews, containerId = 'reviewsContainer') {
    ...
    if (typeof state !== 'undefined') {
        ...
        console.log('✅ All reviews stored in state:', state.reviews.length);
    }
    
    // Display ALL reviews (not just 10)
            ...
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;">
                <div>
                    ...
                    <div style="font-size:14px;color:var(--text-muted);">
                        ${review.stars || '⭐'.repeat(Math.min(review.rating, 5))}
                    </div>
                </div>
                <span style="font-size:12px;color:var(--text-muted);">
                    ${review.formatted_date || review.date || new Date(review.created_at).toLocaleDateString('en-IN') || ''}
                </span>
            </div>
