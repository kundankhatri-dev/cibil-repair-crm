...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_SERVER['HTTP_X_REQUESTED_WITH'])) {
    ...
    $service_id = (int)($data['service_id'] ?? 3);
    $service_name = 'Suit Filed Clearance';
    $amount = 15999;
    ...
    if (strlen($name) < 3 || strlen($name) > 100) {
        echo json_encode(['success' => false, 'error' => 'Name must be between 3 and 100 characters']);
        exit;
    }
...
<head>
  ...
  <meta name="description" content="Remove suit filed entries from your CIBIL report with expert legal assistance. Improve your credit score by 80-150 points. 98% success rate. Money-back guarantee.">
  <meta name="keywords" content="suit filed clearance, legal suit removal, CIBIL suit entry, court case removal, credit report legal entry, suit filed removal">
  <meta name="author" content="CIBIL Repair">
  <title>Suit Filed Clearance — Remove Legal Entries from CIBIL | CIBIL Score Repair</title>
  <link rel="canonical" href="https://cibilrepair.in/service/suit-filled">
  ...
  <!-- ============================================================
    ...
    <!-- ============================================================
     SCHEMA 4: SERVICE (SUIT FILED CLEARANCE)
     ============================================================ -->
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Legal Suit — Complete Removal",
      "image": "https://cibilrepair.in/images/services/suit-removal.jpg",
      "description": "Permanent removal of court case and legal suit entries from credit reports. Handled by in-house legal team with full court documentation, lawyer coordination, and bureau disputes.",
      "provider": {
        "@type": "Organization",
        "name": "CIBIL Repair",
        "alternateName": ["CIBIL Repair India", "CIBIL"],
      ...
      "url": "https://cibilrepair.in/service/suit-filled",
      "areaServed": "IN",
      "serviceType": "Legal Removal",
      "offers": {
        "@type": "Offer",
        "priceCurrency": "INR",
        "price": "15999",
      ...
      "audience": {
        "@type": "Audience",
        "name": "Individuals with legal suit entries on their credit report"
      },
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://cibilrepair.in/service/suit-filled"
      }
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "Suit Filed Clearance — Remove Legal Entries from CIBIL | CIBIL Repair",
      "description": "Remove suit filed entries from your CIBIL report with expert legal assistance. Improve your credit score by 80-150 points. 98% success rate. Money-back guarantee.",
      "url": "https://cibilrepair.in/service/suit-filled",
      "mainEntity": {
        "@type": "Service",
        "name": "Legal Suit — Complete Removal",
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Suit Filed Clearance",
          "item": "https://cibilrepair.in/service/suit-filled"
        }
      ]
    }
    </script>
    ...
    <!-- ============================================================
     SCHEMA 7: PRODUCT/OFFER (SUIT FILED CLEARANCE)
     ============================================================ -->
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Product",
      "name": "Legal Suit — Complete Removal Service",
      "description": "Permanent removal of court case and legal suit entries from credit reports. Handled by in-house legal team with full court documentation, lawyer coordination, and bureau disputes.",
      "image": "https://cibilrepair.in/images/services/suit-removal.jpg",
      "brand": {
        "@type": "Brand",
...
.ms-icon.g{background:rgba(34,197,94,.2)}.ms-icon.b{background:rgba(76,140,255,.2)}.ms-icon.y{background:rgba(245,197,24,.15)}.ms-icon.r{background:rgba(239,68,68,.2)}
.ms-text{flex:1}
...
.ms-val.g{color:var(--green)}.ms-val.y{color:var(--gold)}.ms-val.b{color:#7ab4ff}.ms-val.r{color:#ff7a7a}
...
.ck-icon{width:64px;height:64px;border-radius:16px;display:flex;align-items:center;justify-content:center;font-size:26px;margin:0 auto 18px;background:linear-gradient(135deg,#fff8e0,#fde68a);transition:transform .3s}
    ...
    <li class="nl-item">
      ...
      <div class="dd dd-wide">
        ...
        <div class="dd-col">
          ...
          <a href="/service/suit-filled.php" style="color:var(--blue2);background:#f0f7ff"><i class="fas fa-gavel"></i><div><strong>Legal Removal</strong><span>Legal entry removal</span></div></a>
        </div>
        <div class="dd-col">
          ...
          <a href="/service/profile.php"><i class="fas fa-user-edit"></i><div><strong>Quick Fix</strong><span>Fix name, PAN, address errors</span></div></a>
...
<section class="page-hero">
  ...
  <div class="ph-inner">
    <div>
      <div class="ph-badge r"><div class="ph-dot"></div> Suit Filed Clearance — All 4 Bureaus</div>
      <h1 class="ph-h1 r">
        <span class="w">SUIT FILED</span>
        <span class="g">CLEARANCE</span>
        <span class="y">LEGAL REMOVAL</span>
      </h1>
      <p class="ph-sub r">A "Suit Filed" remark is the most damaging legal entry on your CIBIL report — it drops your score by 80–150 points and blocks every loan application. Our expert legal team removes it across all 4 bureaus using court orders, RBI filings, and Banking Ombudsman escalation.</p>
      <div class="ph-acts r">
        <button class="btn-primary" onclick="document.getElementById('fullName').focus();document.getElementById('fullName').scrollIntoView({behavior:'smooth',block:'center'})">
          <i class="fas fa-gavel"></i> Clear My Suit Entry Now
        </button>
        <a href="#what-we-fix" class="btn-ghost"><i class="fas fa-arrow-down"></i> See How It Works</a>
      </div>
      <div class="ph-trust r">
        <div class="pht"><span class="pht-n">98%</span><div class="pht-l">Success Rate</div></div>
        <div class="pht"><span class="pht-n">30–45</span><div class="pht-l">Day Resolution</div></div>
        <div class="pht"><span class="pht-n">150 pts</span><div class="pht-l">Max Score Gain</div></div>
        <div class="pht"><span class="pht-n">2500+</span><div class="pht-l">Suit Entries Cleared</div></div>
      </div>
    </div>
    ...
    <div class="ph-card r">
      <div class="ph-card-header">
        ...
        <div class="ph-live">Expert Legal Process</div>
      </div>
      <div class="milestones">
        <div class="ms"><div class="ms-icon y">📋</div><div class="ms-text"><div class="ms-title">Court Document Help</div><div class="ms-sub">We collect orders, decrees &amp; settlement deeds</div></div><div class="ms-val y">Secured</div></div>
        <div class="ms"><div class="ms-icon r">⚖️</div><div class="ms-text"><div class="ms-title">Legal Dispute Filing</div><div class="ms-sub">Strong notices filed across all 4 bureaus</div></div><div class="ms-val r">All 4</div></div>
        <div class="ms"><div class="ms-icon b">🏛️</div><div class="ms-text"><div class="ms-title">Ombudsman Escalation</div><div class="ms-sub">RBI &amp; Banking Ombudsman if bureau refuses</div></div><div class="ms-val b">Covered</div></div>
        <div class="ms"><div class="ms-icon g">📈</div><div class="ms-text"><div class="ms-title">Score Improvement</div><div class="ms-sub">Up to 150 points expected gain</div></div><div class="ms-val g">45 Days</div></div>
      </div>
    </div>
  </div>
</section>
...
<div class="breadcrumb-bar">
  <div class="bc-inner">
    ...
    <span>›</span>
    <span class="current">Suit Filed Clearance</span>
  </div>
</div>
...
<div class="stats-band">
  <div class="sb-grid">
    <div class="sb-item r"><span class="sb-num gold" data-target="95" data-s="%">0</span><div class="sb-desc">Banks Auto-Reject Suit Filed Accounts</div></div>
    <div class="sb-item r"><span class="sb-num green" data-target="150" data-s=" pts">0</span><div class="sb-desc">Max Score Gain After Clearance</div></div>
    <div class="sb-item r"><span class="sb-num blue" data-target="45" data-s=" Days">0</span><div class="sb-desc">Fastest Resolution Time</div></div>
...
<section class="process-sec">
  <div class="W">
    <div class="sh r">
      ...
      <h2 class="st" style="color:#fff">Our <em>Legal Clearance Process</em></h2>
      <p class="ss" style="color:rgba(255,255,255,.5)">Six expert-led steps from court document collection to confirmed removal across all four credit bureaus.</p>
    </div>
    <div class="steps-grid">
      <div class="step-card r">
        <div class="step-num-wrap"><i class="fas fa-file-contract"></i></div>
        <div class="step-title">Verify Suit Entry</div>
        <p class="step-desc">We review your credit report, court records, and case status to confirm eligibility and strategy.</p>
      </div>
      <div class="step-card r">
        <div class="step-num-wrap" style="background:linear-gradient(135deg,var(--blue),var(--blue2))"><i class="fas fa-gavel"></i></div>
        <div class="step-title">Obtain Court Orders</div>
        <p class="step-desc">We help collect the final court order, decree, dismissal, or settlement deed — the key document.</p>
      </div>
      <div class="step-card r">
        <div class="step-num-wrap" style="background:linear-gradient(135deg,#d97706,var(--gold2))"><i class="fas fa-pen-alt"></i></div>
        <div class="step-title">Draft Legal Notices</div>
        <p class="step-desc">Bureau-specific dispute notices drafted citing the court order, RBI guidelines, and CIC Act 2005.</p>
      </div>
      <div class="step-card r">
        <div class="step-num-wrap"><i class="fas fa-paper-plane"></i></div>
        <div class="step-title">File with All 4 Bureaus</div>
        <p class="step-desc">Disputes filed simultaneously with CIBIL, Equifax, Experian &amp; CRIF with daily follow-up.</p>
      </div>
      <div class="step-card r">
        ...
        <p class="step-desc">Banking Ombudsman and RBI Consumer Protection filing — or court direction — if bureau refuses.</p>
      </div>
      <div class="step-card r">
        ...
        <p class="step-desc">Suit entry removed or updated, reports confirmed across all bureaus, resolution summary sent.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="sec" id="what-we-fix">
  <div class="W">
    <div class="sh r">
      ...
      <h2 class="st">What We <em>Resolve</em></h2>
      <p class="ss">Every type of suit filed situation handled with a tailored legal strategy — no entry is left unresolved.</p>
    </div>
    <div class="check-grid" style="margin-bottom:80px">
      <div class="ck r">
        <div class="ck-icon">🏛️</div>
        <div class="ck-name">Dismissed / Withdrawn Suits</div>
        <p class="ck-desc">If the bank withdrew the case or the court dismissed it, we use the dismissal order to force immediate bureau update.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">⚖️</div>
        <div class="ck-name">Decreed &amp; Paid Suits</div>
        <p class="ck-desc">Court decreed the amount and you have paid it? We obtain the satisfaction receipt and file for removal across all bureaus.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">🤝</div>
        <div class="ck-name">Out-of-Court Settlements</div>
        <p class="ck-desc">Cases settled outside court with a deed or agreement — we use the settlement document as legal proof for bureau disputes.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">📋</div>
        <div class="ck-name">Time-Barred Suit Entries</div>
        <p class="ck-desc">Suit filed entries older than 3 years without a court decree are time-barred — we dispute these on legal limitation grounds.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">🔍</div>
        <div class="ck-name">Pending Case Disputes</div>
        <p class="ck-desc">Case still pending in court? We file disputes arguing bureaus must not reflect pending suits until a final verdict is passed.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">📊</div>
        <div class="ck-name">Multi-Lender Suit Entries</div>
        <p class="ck-desc">Suit filed by multiple lenders across different accounts? We handle all simultaneously — one engagement, full resolution.</p>
      </div>
    </div>
    ...
    <div class="service-layout">
      <div class="service-content">
        ...
        <h2>📖 What is Suit Filed Clearance?</h2>
        <p>A "Suit Filed" entry appears on your credit report when a lender has initiated legal proceedings against you to recover a debt. This is the single most damaging negative remark on a credit report — it tells every future lender that you were taken to court for non-payment, which is far more severe than a simple default or settlement remark.</p>
        <p>Our Suit Filed Clearance service helps you remove this entry by proving that the case has been dismissed, decreed and paid, settled, or is legally time-barred. We handle the entire legal and documentation process — from obtaining court orders to filing disputes with all four bureaus and escalating to the Banking Ombudsman and RBI if needed.</p>

        <div class="inline-stats">
          <div class="istat r"><span class="istat-n">95%</span><div class="istat-l">Banks auto-reject suit filed applicants</div></div>
          <div class="istat r"><span class="istat-n">+150 pts</span><div class="istat-l">Max score gain after removal</div></div>
          <div class="istat r"><span class="istat-n">45 Days</span><div class="istat-l">Fastest full resolution in India</div></div>
        </div>

        <h2>🔍 How a Suit Filed Entry Hurts You</h2>
        <div class="impact-grid">
          <div class="impact-item"><i class="fas fa-chart-line fa-rotate-180"></i><span>80–150 point score drop</span></div>
          <div class="impact-item"><i class="fas fa-ban"></i><span>95% of banks auto-reject</span></div>
          <div class="impact-item"><i class="fas fa-gavel"></i><span>Legal red flag on credit history</span></div>
          <div class="impact-item"><i class="fas fa-clock"></i><span>Stays on report indefinitely</span></div>
          <div class="impact-item"><i class="fas fa-home"></i><span>Home loan approval impossible</span></div>
          <div class="impact-item"><i class="fas fa-briefcase"></i><span>Business loan eligibility lost</span></div>
          <div class="impact-item"><i class="fas fa-percent"></i><span>3–6% higher interest if approved</span></div>
          <div class="impact-item"><i class="fas fa-shield-alt"></i><span>Employment &amp; rental background checks flagged</span></div>
        </div>

        <h2>🎯 What You Receive</h2>
        <p>Our suit filed clearance service is a complete end-to-end legal process — not just a letter service:</p>
        <ul class="report-list">
          <li><span>📋</span> Court document collection assistance (orders, decrees, dismissals)</li>
          <li><span>✅</span> Suit entry disputed and removed across all 4 bureaus</li>
          <li><span>📝</span> Legal dispute notices filed on your behalf</li>
          <li><span>🏦</span> Bank negotiation &amp; direct lender escalation team</li>
          <li><span>⚖️</span> Banking Ombudsman &amp; RBI Consumer Protection filing</li>
          <li><span>🏛️</span> Court direction approach if bureau refuses to comply</li>
          <li><span>📋</span> Updated credit reports confirming entry removal</li>
          <li><span>💰</span> 100% money-back if clearance cannot be achieved</li>
        </ul>

        <h2>✅ Benefits of Suit Filed Clearance</h2>
        <div class="benefits-grid">
          <div class="benefit-item"><strong>📈 Massive Score Jump</strong><span>Up to 150 points increase once the suit entry is removed</span></div>
          <div class="benefit-item"><strong>🏦 Unlock Loan Approvals</strong><span>95% of banks that rejected you will now consider your application</span></div>
          <div class="benefit-item"><strong>⚖️ In-House Legal Team</strong><span>Our specialists handle everything — you don't need your own lawyer</span></div>
          <div class="benefit-item"><strong>🏛️ Court Direction if Needed</strong><span>We can approach the court for a direction to update the credit report</span></div>
          <div class="benefit-item"><strong>🏠 Home Loan Eligibility</strong><span>Major banks approve home loans only after suit entry is removed</span></div>
          <div class="benefit-item"><strong>📊 Clean Legal Record</strong><span>Your report reflects no legal proceedings — fully cleared credit history</span></div>
        </div>

        <h2>❓ Frequently Asked Questions</h2>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">Can a suit filed entry be removed if the case is still pending in court? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">Yes. We can file a dispute arguing that the credit report must not reflect a pending suit until a final judgement is passed. RBI guidelines strongly discourage lenders from reporting ongoing suits before a court verdict. We frame this legally and file with the bureau and the lender's nodal officer simultaneously.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">How long does suit filed clearance take? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">Most cases with a final court order are resolved within 30–45 working days. Each bureau is legally required to respond within 30 days under CIC Act 2005. If the case is still pending or documents are delayed, it may take longer — we keep you updated at every stage and escalate proactively to meet timelines.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">Do I need to hire my own lawyer? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">No. Our in-house legal team handles all drafting, filings, and escalations. You only need to provide any court documents you already have (if any). If you don't have the court orders, we help you obtain them through the relevant court registry. Everything is covered in the single service fee.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">What if the bank or bureau refuses to remove the entry? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">Refusal triggers our escalation protocol: we file a formal complaint with the Banking Ombudsman, then with RBI Consumer Protection. If those avenues don't resolve it, we approach the court for a specific direction ordering the bureau to update the report. Under CIC Regulations, this process has a very high success rate.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">What if I have multiple suit filed entries from different lenders? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">We handle multiple suit entries simultaneously under our service. All entries across different lenders and bureaus are addressed in a single engagement. Contact us before purchasing if you have more than two suit entries so we can assess your specific case and confirm coverage.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">Is my personal and legal data safe with CIBIL Repair? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">Absolutely. All data is encrypted with 256-bit SSL. We are fully compliant with the IT Act 2000 and DPDP Act 2023. Your court documents and personal information are never shared with third parties and are used solely for filing your dispute with the relevant bureaus and lenders.</div>
        </div>
      ...
      <div>
        <div class="payment-card r">
          <div class="price-badge">
            <div class="price">₹15,999 <small>+ GST</small></div>
            <div class="gst-note">18% GST applicable — total ₹18,879</div>
            <span class="save-tag">⚡ Up to 150 Points Score Boost</span>
          </div>

          <ul class="features-list">
            <li><i class="fas fa-check-circle"></i> Complete legal suit entry removal</li>
            <li><i class="fas fa-check-circle"></i> Court document collection assistance</li>
            <li><i class="fas fa-check-circle"></i> Legal dispute notice drafting</li>
            <li><i class="fas fa-check-circle"></i> Dispute filing with all 4 bureaus</li>
            <li><i class="fas fa-check-circle"></i> Bank negotiation &amp; direct escalation</li>
            <li><i class="fas fa-check-circle"></i> Banking Ombudsman approach</li>
            <li><i class="fas fa-check-circle"></i> RBI Consumer Protection filing</li>
            <li><i class="fas fa-check-circle"></i> Court direction if bureau refuses</li>
            <li><i class="fas fa-check-circle"></i> Updated credit report confirmation</li>
            <li><i class="fas fa-check-circle"></i> Email &amp; WhatsApp support for 60 days</li>
          ...
          <form id="paymentForm">
            ...
            <button type="submit" class="pay-btn" id="payBtn">
              <i class="fas fa-lock"></i> Pay ₹15,999 + GST &amp; Clear My Suit Entry
            </button>
          </form>
...
<section class="trust-sec">
  <div class="W">
    <div class="sh r">
      ...
      <p class="ss" style="color:rgba(255,255,255,.5)">Every commitment we make is backed by verified results, legal expertise, and real client outcomes.</p>
    </div>
    <div class="trust-grid">
      ...
      <div class="trust-card r"><div class="tci b">🔒</div><h4>256-bit SSL Encryption</h4><p>Bank-grade security at every step. Your court documents and personal data are always encrypted and protected.</p></div>
      ...
      <div class="trust-card r"><div class="tci y">💰</div><h4>Money-Back Guarantee</h4><p>If we cannot remove your suit filed entry, you receive a full refund — no questions asked, no delays.</p></div>
...
<section class="cta-sec">
  <div class="W">
    <div class="cta-inner r">
      <h2 class="cta-h">Have a Suit Filed Entry Blocking Your <em>Loan Approvals?</em></h2>
      <p class="cta-p">Talk to our legal expert before you pay anything. Free guidance, no obligation — real answers about removing your suit entry.</p>
      <div class="cta-acts">
        <button class="btn-primary" onclick="openModal()"><i class="fas fa-rocket"></i> Get Free Consultation</button>
        <a href="https://wa.me/919905482503?text=Hi%2C%20I%20need%20help%20with%20suit%20filed%20clearance%20on%20my%20CIBIL%20report" class="btn-ghost" target="_blank"><i class="fab fa-whatsapp"></i> Chat on WhatsApp</a>
      ...
      <div class="cta-trust">
        ...
        <div class="ct"><i class="fas fa-check-circle"></i> In-house legal team</div>
        <div class="ct"><i class="fas fa-check-circle"></i> Money-back guarantee</div>
        <div class="ct"><i class="fas fa-check-circle"></i> Resolved in 30–45 working days</div>
      </div>
    </div>
  </div>
</section>
...
<!-- WhatsApp FAB -->
<a href="https://wa.me/919905482503?text=Hi%2C%20I%20need%20help%20with%20suit%20filed%20clearance%20on%20my%20CIBIL%20report" class="wa" target="_blank" aria-label="WhatsApp"><i class="fab fa-whatsapp"></i></a>
...
<div class="modal-bg" id="modal">
  <div class="modal-box">
    ...
    <h3 class="m-h">Free Suit Filed Clearance Consult</h3>
    <p class="m-s">Get expert legal advice on removing your suit entry. Our team contacts you within 2 hours.</p>
...
const SERVICE = { id: 3, name: 'Suit Filed Clearance', amount: 15999, caseNo: 'SFD' + Date.now() };
...
function submitLead() {
    ...
    const msg = encodeURIComponent('Hi! I want a free consultation for suit filed clearance on my CIBIL report.\n\nName: ' + n + '\nPhone: ' + p + (em ? '\nEmail: ' + em : ''));
...
function hideLoading() { 
    if (payBtn) { payBtn.disabled = false; payBtn.innerHTML = '<i class="fas fa-lock"></i> Pay ₹15,999 + GST &amp; Clear My Suit Entry'; }
}
    ...
    form.addEventListener('submit', async function(e) {
        ...
        const options = {
            ...
            handler: function(response) {
                hideLoading();
                showResultModal(true, 'Payment Successful!', `Thank you ${fullName}! Your payment has been completed. Our legal team will contact you within 24 hours to begin your suit filed clearance process.`, response.razorpay_payment_id);
                form.reset();
            },
            modal: { 
                ondismiss: function() { 
