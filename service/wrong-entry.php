...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_SERVER['HTTP_X_REQUESTED_WITH'])) {
    ...
    $service_id = (int)($data['service_id'] ?? 5);
    $service_name = 'Wrong Entry Clearance';
    $amount = 10999;
...
<head>
  ...
  <meta name="description" content="Remove unauthorized loans, fraudulent accounts, and wrong entries from your CIBIL report. Protect your identity and improve credit score by 30-70 points. 98% success rate.">
  <meta name="keywords" content="wrong entry clearance, unauthorized loan removal, identity theft protection, fraud loan removal, CIBIL wrong entry, credit report error removal">
  <meta name="author" content="CIBIL Repair">
  <title>Wrong Entry Clearance — Remove Unauthorized Loans & Errors | CIBIL Score Repair</title>
  <link rel="canonical" href="https://cibilrepair.in/service/wrong-entry">
  ...
  <!-- ============================================================
    ...
    <!-- ============================================================
     SCHEMA 4: SERVICE (WRONG ENTRY CLEARANCE)
     ============================================================ -->
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Fraud & Wrong Entry Removal",
      "image": "https://cibilrepair.in/images/services/fraud-removal.jpg",
      "description": "Investigate and permanently remove unauthorized loans, identity theft entries, and fraudulent accounts. Includes police/FIR complaint filing assistance and full   credit profile protection.",
      "provider": {
        "@type": "Organization",
        "name": "CIBIL Repair",
        "alternateName": ["CIBIL Repair India", "CIBIL"],
      ...
      "url": "https://cibilrepair.in/service/wrong-entry",
      "areaServed": "IN",
      ...
      "audience": {
        "@type": "Audience",
        "name": "Individuals affected by identity theft or fraudulent credit entries"
      },
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://cibilrepair.in/service/wrong-entry"
      }
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "Wrong Entry Clearance — Remove Unauthorized Loans & Errors | CIBIL Repair",
      "description": "Remove unauthorized loans, fraudulent accounts, and wrong entries from your CIBIL report. Protect your identity and improve credit score by 30-70 points. 98% success  rate.",
      "url": "https://cibilrepair.in/service/wrong-entry",
      "mainEntity": {
        "@type": "Service",
        "name": "Fraud & Wrong Entry Removal",
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Wrong Entry Clearance",
          "item": "https://cibilrepair.in/service/wrong-entry"
        }
      ]
    }
    </script>
    ...
    <!-- ============================================================
     SCHEMA 7: PRODUCT/OFFER (WRONG ENTRY CLEARANCE)
     ============================================================ -->
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Product",
      "name": "Fraud & Wrong Entry Removal Service",
      "description": "Investigate and permanently remove unauthorized loans, identity theft entries, and fraudulent accounts. Includes police/FIR complaint filing assistance and full credit profile protection.",
      "image": "https://cibilrepair.in/images/services/fraud-removal.jpg",
      "brand": {
        "@type": "Brand",
    ...
    <li class="nl-item">
      ...
      <div class="dd dd-wide">
        ...
        <div class="dd-col">
          ...
          <a href="/service/wrong-entry.php" style="color:var(--blue2);background:#f0f7ff"><i class="fas fa-times-circle"></i><div><strong>Fraud Protection</strong><span>Fraud &amp; identity theft disputes</span></div></a>
        </div>
      </div>
    </li>
    <li class="nl-item">
...
<section class="page-hero">
  ...
  <div class="ph-inner">
    <div>
      <div class="ph-badge r"><div class="ph-dot"></div> Wrong Entry Clearance — All 4 Bureaus</div>
      <h1 class="ph-h1 r">
        <span class="w">WRONG ENTRY</span>
        <span class="g">CLEARANCE</span>
        <span class="y">FRAUD REMOVAL</span>
      </h1>
      <p class="ph-sub r">Unauthorized loans, duplicate accounts, and fraudulent entries on your CIBIL report drop your score by 30–70 points and trigger automatic loan rejections. Our expert team removes every wrong entry across all 4 bureaus using legal dispute filings, identity theft protection, and Banking Ombudsman escalation.</p>
      <div class="ph-acts r">
        <button class="btn-primary" onclick="document.getElementById('fullName').focus();document.getElementById('fullName').scrollIntoView({behavior:'smooth',block:'center'})">
          <i class="fas fa-shield-alt"></i> Remove My Wrong Entry Now
        </button>
      ...
      <div class="ph-trust r">
        ...
        <div class="pht"><span class="pht-n">70 pts</span><div class="pht-l">Max Score Gain</div></div>
        <div class="pht"><span class="pht-n">4000+</span><div class="pht-l">Wrong Entries Cleared</div></div>
      </div>
    </div>
    ...
    <div class="ph-card r">
      <div class="ph-card-header">
        ...
        <div class="ph-live">Expert Dispute Process</div>
      </div>
      <div class="milestones">
        <div class="ms"><div class="ms-icon y">🔍</div><div class="ms-text"><div class="ms-title">Full 4-Bureau Audit</div><div class="ms-sub">Every wrong entry identified across CIBIL, Equifax, Experian &amp; CRIF</div></div><div class="ms-val y">All 4</div></div>
        <div class="ms"><div class="ms-icon r">🛡️</div><div class="ms-text"><div class="ms-title">Identity Theft Protection</div><div class="ms-sub">Police complaint &amp; fraud removal support</div></div><div class="ms-val r">Covered</div></div>
        <div class="ms"><div class="ms-icon b">⚖️</div><div class="ms-text"><div class="ms-title">Legal Dispute Filing</div><div class="ms-sub">RBI-backed notices to bureaus &amp; lenders</div></div><div class="ms-val b">Filed</div></div>
        <div class="ms"><div class="ms-icon g">📈</div><div class="ms-text"><div class="ms-title">Score Improvement</div><div class="ms-sub">Up to 70 points expected gain</div></div><div class="ms-val g">45 Days</div></div>
      </div>
    </div>
  </div>
</section>
...
<div class="breadcrumb-bar">
  <div class="bc-inner">
    ...
    <span>›</span>
    <span class="current">Wrong Entry Clearance</span>
  </div>
</div>
...
<div class="stats-band">
  <div class="sb-grid">
    <div class="sb-item r"><span class="sb-num gold" data-target="70" data-s=" pts">0</span><div class="sb-desc">Max Score Gain After Wrong Entry Removal</div></div>
    <div class="sb-item r"><span class="sb-num green" data-target="4000" data-s="+">0</span><div class="sb-desc">Wrong Entries Cleared Across India</div></div>
...
<section class="process-sec">
  <div class="W">
    <div class="sh r">
      ...
      <h2 class="st" style="color:#fff">Our <em>Wrong Entry Removal Process</em></h2>
      <p class="ss" style="color:rgba(255,255,255,.5)">Six expert-led steps from full bureau audit to confirmed removal and score recovery across all four credit bureaus.</p>
    </div>
    <div class="steps-grid">
      <div class="step-card r">
        <div class="step-num-wrap"><i class="fas fa-search"></i></div>
        <div class="step-title">Full Bureau Audit</div>
        <p class="step-desc">We pull your credit reports from all 4 bureaus and identify every wrong, duplicate, or fraudulent entry.</p>
      </div>
      <div class="step-card r">
        ...
        <p class="step-desc">We help you gather proof — bank statements, rejection letters, FIR copies — establishing the entry is wrong.</p>
      </div>
      <div class="step-card r">
      ...
      <div class="step-card r">
        ...
        <p class="step-desc">Disputes filed simultaneously with CIBIL, Equifax, Experian &amp; CRIF and the reporting lender, with daily follow-up.</p>
      </div>
      <div class="step-card r">
        ...
        <p class="step-desc">Banking Ombudsman and RBI Consumer Protection filing — plus police complaint support for identity theft cases.</p>
      </div>
      <div class="step-card r">
        ...
        <p class="step-desc">Wrong entry removed, updated reports confirmed across all bureaus, resolution certificate sent to you.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="sec" id="what-we-fix">
  <div class="W">
    <div class="sh r">
      ...
      <h2 class="st">What We <em>Remove</em></h2>
      <p class="ss">Every type of wrong entry handled with a tailored legal strategy — no error is left on your report.</p>
    </div>
    <div class="check-grid" style="margin-bottom:80px">
      <div class="ck r">
        <div class="ck-icon">🚫</div>
        <div class="ck-name">Unauthorized Loans</div>
        <p class="ck-desc">Loans opened fraudulently in your name without your knowledge or consent — we remove them using identity theft dispute filings and police complaint support.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">📋</div>
        <div class="ck-name">Duplicate Accounts</div>
        <p class="ck-desc">The same loan appearing twice or more on your report inflates your debt burden. We dispute duplicates and get them consolidated or removed.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">📅</div>
        <div class="ck-name">Incorrect Late Payments</div>
        <p class="ck-desc">Late payment remarks reported in error — payments you made on time but the lender marked as delayed. We correct these with bank statement evidence.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">🪪</div>
        <div class="ck-name">Wrong Personal Details</div>
        <p class="ck-desc">Name, PAN, DOB, or address mismatches can merge your file with another person's. We dispute and correct these identity errors across all bureaus.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">⏳</div>
        <div class="ck-name">Time-Barred Items</div>
        <p class="ck-desc">Accounts or defaults older than 7 years that should have been removed automatically — we dispute their continued presence on legal limitation grounds.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">❌</div>
        <div class="ck-name">Wrong Default Status</div>
        <p class="ck-desc">Active, fully paid, or closed accounts showing as defaulted or written off — we dispute the incorrect status and restore the correct account standing.</p>
      </div>
    </div>
    ...
    <div class="service-layout">
      <div class="service-content">
        ...
        <h2>📖 What is Wrong Entry Clearance?</h2>
        <p>A "wrong entry" is any inaccurate or unauthorized data on your credit report — loans you never took, duplicate accounts, payments wrongly reported as late, incorrect overdue amounts, or identity theft-linked fraud accounts. Such errors can drop your CIBIL score by 30–70 points and trigger automatic loan rejections even when your actual repayment history is clean.</p>
        <p>Our Wrong Entry Clearance service systematically identifies and removes these errors through a legally backed dispute process with all four credit bureaus, restoring your true credit profile so lenders see an accurate picture of your financial behaviour.</p>

        <div class="inline-stats">
          <div class="istat r"><span class="istat-n">70 pts</span><div class="istat-l">Max score gain after wrong entry removal</div></div>
          <div class="istat r"><span class="istat-n">4,000+</span><div class="istat-l">Wrong entries cleared across India</div></div>
          <div class="istat r"><span class="istat-n">45 Days</span><div class="istat-l">Fastest full resolution time</div></div>
        </div>

        <h2>🔍 How Wrong Entries Hurt You</h2>
        <div class="impact-grid">
          <div class="impact-item"><i class="fas fa-chart-line fa-rotate-180"></i><span>30–70 point score drop</span></div>
          <div class="impact-item"><i class="fas fa-ban"></i><span>Automatic loan rejections</span></div>
          <div class="impact-item"><i class="fas fa-user-slash"></i><span>Identity theft risk unresolved</span></div>
          <div class="impact-item"><i class="fas fa-clock"></i><span>Can persist for years if unchallenged</span></div>
          <div class="impact-item"><i class="fas fa-home"></i><span>Home loan approval blocked</span></div>
          <div class="impact-item"><i class="fas fa-briefcase"></i><span>Business loan eligibility lost</span></div>
          <div class="impact-item"><i class="fas fa-percent"></i><span>Higher interest rates if approved</span></div>
          <div class="impact-item"><i class="fas fa-shield-alt"></i><span>Employment background checks flagged</span></div>
        </div>

        <h2>🎯 What You Receive</h2>
        <p>Our wrong entry clearance service is a complete end-to-end legal dispute process — not just a letter service:</p>
        <ul class="report-list">
          <li><span>🔍</span> Complete audit of all 4 bureau reports for wrong entries</li>
          <li><span>✅</span> Wrong entries disputed and removed across all 4 bureaus</li>
          <li><span>📝</span> Legal dispute notices filed on your behalf</li>
          <li><span>🛡️</span> Identity theft FIR support and police complaint filing</li>
        ...
        <h2>✅ Benefits of Wrong Entry Clearance</h2>
        <div class="benefits-grid">
          <div class="benefit-item"><strong>📈 Score Recovery</strong><span>Up to 70 points increase once wrong entries are removed from your report</span></div>
          <div class="benefit-item"><strong>🏦 Unlock Loan Approvals</strong><span>Banks that rejected you will reconsider once your true credit profile is restored</span></div>
          <div class="benefit-item"><strong>🛡️ Stop Identity Theft</strong><span>We help you file police complaints and remove fraudulent loans opened in your name</span></div>
          <div class="benefit-item"><strong>⚖️ Legally Enforced</strong><span>All disputes backed by CIC Act 2005 and RBI guidelines — not just informal requests</span></div>
          <div class="benefit-item"><strong>🏠 Home Loan Eligibility</strong><span>Wrong defaults or fraud accounts are the #1 reason home loans are rejected unfairly</span></div>
          <div class="benefit-item"><strong>📊 Accurate Credit Profile</strong><span>Your report reflects your real financial behaviour — fully corrected across all bureaus</span></div>
        </div>

        <h2>❓ Frequently Asked Questions</h2>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">What types of wrong entries can be removed? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">We remove unauthorized loans, duplicate accounts, incorrect late payment remarks, wrong personal details (name, PAN, address), accounts that don't belong to you, wrong default or written-off status, time-barred items, and any other inaccuracy negatively affecting your score.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">How long does the wrong entry removal process take? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">Most cases are resolved within 30–45 working days. Under the CIC Act 2005, bureaus are legally required to respond within 30 days. We handle all follow-up, reminders, and escalations on your behalf to ensure deadlines are met.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">What if the bank insists the loan in my name is real? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">We help you file a formal police complaint for identity theft, then use that FIR to force removal from your credit report. We have successfully handled hundreds of such identity theft cases. You are not responsible for fraudulent loans, and our legal team will establish that through the proper channels.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">Do I have to pay the fraudulent loan to get it removed? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">Absolutely not. You are not legally responsible for any loan you did not take. Our service focuses entirely on proving the account does not belong to you and getting it removed from your credit report without requiring any payment to the lender.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">What if I have multiple wrong entries from different lenders? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">All wrong entries across different lenders and all four bureaus are addressed under a single service engagement. We handle everything simultaneously so you don't need to manage multiple disputes yourself. Contact us first if you have more than three separate wrong entries so we can assess your case.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">Is my personal data safe with CIBIL Repair? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">Yes. All data is encrypted with 256-bit SSL and we are fully compliant with the IT Act 2000 and DPDP Act 2023. Your documents and personal information are never shared with third parties and are used solely for filing disputes with the relevant bureaus and lenders on your behalf.</div>
        </div>
      ...
      <div>
        <div class="payment-card r">
          <div class="price-badge">
            ...
            <span class="save-tag">⚡ Up to 70 Points Score Recovery</span>
          </div>

          <ul class="features-list">
            <li><i class="fas fa-check-circle"></i> Complete 4-bureau audit &amp; error detection</li>
            <li><i class="fas fa-check-circle"></i> Unauthorized loan removal</li>
            <li><i class="fas fa-check-circle"></i> Duplicate account removal</li>
            <li><i class="fas fa-check-circle"></i> Incorrect personal info correction</li>
            <li><i class="fas fa-check-circle"></i> Identity theft complaint filing support</li>
            ...
            <li><i class="fas fa-check-circle"></i> Bank escalation &amp; direct lender approach</li>
            <li><i class="fas fa-check-circle"></i> Banking Ombudsman filing</li>
            <li><i class="fas fa-check-circle"></i> RBI Consumer Protection complaint</li>
          ...
          <form id="paymentForm">
            ...
            <button type="submit" class="pay-btn" id="payBtn">
              <i class="fas fa-lock"></i> Pay ₹10,999 + GST &amp; Remove Wrong Entries
            </button>
          </form>
...
<section class="trust-sec">
  <div class="W">
    ...
    <div class="trust-grid">
      ...
      <div class="trust-card r"><div class="tci y">💰</div><h4>Money-Back Guarantee</h4><p>If we cannot remove your wrong entry, you receive a full refund — no questions asked, no delays.</p></div>
...
<section class="cta-sec">
  <div class="W">
    <div class="cta-inner r">
      <h2 class="cta-h">Found Wrong Entries Blocking Your <em>Loan Approvals?</em></h2>
      <p class="cta-p">Talk to our expert before you pay anything. Free guidance, no obligation — real answers about removing your wrong entries today.</p>
      <div class="cta-acts">
        <button class="btn-primary" onclick="openModal()"><i class="fas fa-rocket"></i> Get Free Consultation</button>
        <a href="https://wa.me/919905482503?text=Hi%2C%20I%20need%20help%20with%20wrong%20entry%20clearance%20on%20my%20CIBIL%20report" class="btn-ghost" target="_blank"><i class="fab fa-whatsapp"></i> Chat on WhatsApp</a>
...
<!-- WhatsApp FAB -->
<a href="https://wa.me/919905482503?text=Hi%2C%20I%20need%20help%20with%20wrong%20entry%20clearance%20on%20my%20CIBIL%20report" class="wa" target="_blank" aria-label="WhatsApp"><i class="fab fa-whatsapp"></i></a>
...
<div class="modal-bg" id="modal">
  <div class="modal-box">
    ...
    <h3 class="m-h">Free Wrong Entry Consult</h3>
    <p class="m-s">Get expert advice on removing wrong entries from your report. Our team contacts you within 2 hours.</p>
...
const SERVICE = { id: 5, name: 'Wrong Entry Clearance', amount: 10999, caseNo: 'WEC' + Date.now() };
...
function submitLead() {
    ...
    const msg = encodeURIComponent('Hi! I want a free consultation for wrong entry clearance on my CIBIL report.\n\nName: ' + n + '\nPhone: ' + p + (em ? '\nEmail: ' + em : ''));
...
function hideLoading() { 
    if (payBtn) { payBtn.disabled = false; payBtn.innerHTML = '<i class="fas fa-lock"></i> Pay ₹10,999 + GST &amp; Remove Wrong Entries'; }
}
    ...
    form.addEventListener('submit', async function(e) {
        ...
        const options = {
            ...
            handler: function(response) {
                hideLoading();
                showResultModal(true, 'Payment Successful!', `Thank you ${fullName}! Your payment has been completed. Our team will contact you within 24 hours to begin your wrong entry clearance process.`, response.razorpay_payment_id);
                form.reset();
            },
            modal: { 
                ondismiss: function() { 
