...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_SERVER['HTTP_X_REQUESTED_WITH'])) {
    ...
    $service_id   = (int)($data['service_id'] ?? 7);
    $service_name = 'Starter - Profile Correction';
    $amount       = 4999;
...
<head>
  ...
  <meta name="description" content="Fix name mismatches, address errors, PAN card linking issues, and other personal information discrepancies on your CIBIL report. Fast 15-20 day resolution.">
  <meta name="keywords" content="profile correction, CIBIL name correction, address correction, PAN linking, starter plan, credit profile fix">
  <meta name="author" content="CIBIL Repair">
  <title>Starter — Profile Correction &amp; Quick Fixes | CIBIL Score Repair</title>
  <link rel="canonical" href="https://cibilrepair.in/service/starter">
  ...
  <!-- ============================================================
    ...
    <!-- ============================================================
     SCHEMA 4: SERVICE (STARTER — PROFILE CORRECTION)
     ============================================================ -->
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Starter — Profile Correction & Quick Fixes",
      "image": "https://cibilrepair.in/images/services/profile-correction.jpg",
      "description": "Fix name, PAN, address, and date of birth discrepancies across all four credit bureaus simultaneously. Fast and permanent resolution in 15-20 days. +20-40 points expected.",
      "provider": {
        "@type": "Organization",
        "name": "CIBIL Repair",
        "alternateName": ["CIBIL Repair India", "CIBIL"],
      ...
      "url": "https://cibilrepair.in/service/starter",
      "areaServed": "IN",
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://cibilrepair.in/service/starter"
      }
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "Starter — Profile Correction & Quick Fixes | CIBIL Repair",
      "description": "Fix name mismatches, address errors, PAN card linking issues, and other personal information discrepancies on your CIBIL report. Fast 15-20 day resolution.",
      "url": "https://cibilrepair.in/service/starter",
      "mainEntity": {
        "@type": "Service",
        "name": "Starter — Profile Correction & Quick Fixes",
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Starter — Profile Correction",
          "item": "https://cibilrepair.in/service/starter"
        }
      ]
    }
    </script>
    ...
    <!-- ============================================================
     SCHEMA 7: PRODUCT/OFFER (STARTER)
     ============================================================ -->
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
...
/* ============================================================
   PAGE HERO — identical to existing pages
   ============================================================ */
...
<section class="page-hero">
  ...
  <div class="ph-inner">
    <div>
      <div class="ph-badge r"><div class="ph-dot"></div> Starter Plan — All 4 Bureaus</div>
      <h1 class="ph-h1 r">
        <span class="w">PROFILE</span>
        <span class="g">CORRECTION</span>
        <span class="y">STARTER PLAN</span>
      </h1>
      <p class="ph-sub r">Fix name mismatches, wrong PAN, incorrect address, and date of birth errors across CIBIL, Equifax, Experian &amp; CRIF within 15–20 days. The perfect starting point for profile cleanup.</p>
      <div class="ph-acts r">
      ...
      <div class="ph-trust r">
        ...
        <div class="pht"><span class="pht-n">+20-40</span><div class="pht-l">Points Expected</div></div>
      </div>
    </div>
    ...
    <div class="ph-card r">
      ...
      <div class="milestones">
        ...
        <div class="ms"><div class="ms-icon g">📅</div><div class="ms-text"><div class="ms-title">DOB &amp; Phone Fix</div><div class="ms-sub">All personal fields aligned</div></div><div class="ms-val g">15 Days</div></div>
      </div>
    </div>
  </div>
</section>
...
<div class="breadcrumb-bar">
  <div class="bc-inner">
    ...
    <span>›</span>
    <span class="current">Starter — Profile Correction</span>
  </div>
</div>
  ...
  <div class="W">
    ...
    <div class="service-layout">
      <div class="service-content">
        ...
        <p>The Starter Plan ensures every bureau holds exactly the same, accurate information as on your official documents (PAN, Aadhaar, Passport). It is the fastest way to remove unfair score damage — and one of the most commonly overlooked fixes.</p>
        ...
        <p>Our Starter Plan is a complete end-to-end fix — not just a dispute letter:</p>
        <ul class="report-list">
          ...
          <li><span>📞</span> Expert support via WhatsApp &amp; email for 30 days</li>
        ...
        <div class="benefits-grid">
          ...
          <div class="benefit-item"><strong>📈 Score Improvement</strong><span>Removing wrongly mapped defaults can boost your score 20–40 points</span></div>
        ...
        <div class="faq-item" onclick="this.classList.toggle('active')">
          ...
          <div class="faq-answer">Yes. Once the correct profile is updated, any negative entries that were incorrectly mapped from another person's record are removed. Most clients see an improvement of 20–40 points.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
      ...
      <div>
        <div class="payment-card r">
          <div class="price-badge">
            <div class="price">₹4,999 <small>+ GST</small></div>
            <div class="gst-note">18% GST applicable — total ₹5,899</div>
          ...
          <ul class="features-list">
            ...
            <li><i class="fas fa-check-circle"></i> Email &amp; WhatsApp support for 30 days</li>
          ...
          <form id="paymentForm">
            ...
            <button type="submit" class="pay-btn" id="payBtn">
              <i class="fas fa-lock"></i> Pay ₹4,999 + GST &amp; Fix My Profile
            </button>
          </form>
  ...
  <div class="W">
    <div class="cta-inner r">
      ...
      <div class="cta-acts">
        ...
        <a href="https://wa.me/919905482503?text=Hi%2C%20I%20need%20help%20with%20starter%20profile%20correction%20on%20my%20CIBIL%20report" class="btn-ghost" target="_blank"><i class="fab fa-whatsapp"></i> Chat on WhatsApp</a>
...
<!-- WhatsApp FAB -->
<a href="https://wa.me/919905482503?text=Hi%2C%20I%20need%20help%20with%20starter%20profile%20correction%20on%20my%20CIBIL%20report" class="wa" target="_blank" aria-label="WhatsApp"><i class="fab fa-whatsapp"></i></a>
...
const SERVICE = { id: 7, name: 'Starter — Profile Correction', amount: 4999, caseNo: 'STR' + Date.now() };
...
function hideLoading() { 
    if (payBtn) { payBtn.disabled = false; payBtn.innerHTML = '<i class="fas fa-lock"></i> Pay ₹4,999 + GST &amp; Fix My Profile'; }
}
