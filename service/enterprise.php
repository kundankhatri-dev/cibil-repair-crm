...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_SERVER['HTTP_X_REQUESTED_WITH'])) {
    ...
    $service_id   = (int)($data['service_id'] ?? 9);
    $service_name = 'Enterprise — Legal & Complex Cases';
    $amount       = 0; // Custom quote
...
<head>
  ...
  <meta name="description" content="Remove commercial CIBIL entries, legal suits, and complex credit issues. Expert legal team handles court documentation, FIR support, and full credit profile protection.">
  <meta name="keywords" content="enterprise credit repair, commercial CIBIL, suit filed removal, legal entry removal, company credit repair, LLP credit fix, legal case removal">
  <meta name="author" content="CIBIL Repair">
  <title>Enterprise — Legal & Complex Cases | CIBIL Score Repair</title>
  <link rel="canonical" href="https://cibilrepair.in/service/enterprise">
  ...
  <!-- ============================================================
    ...
    <!-- ============================================================
     SCHEMA 4: SERVICE (ENTERPRISE)
     ============================================================ -->
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Enterprise — Legal & Complex Cases",
      "image": "https://cibilrepair.in/images/services/enterprise.jpg",
      "description": "Remove commercial CIBIL entries, legal suits, and complex credit issues. Expert legal team handles court documentation, FIR support, and full credit profile   protection for companies, LLPs, and proprietorships.",
      "provider": {
        "@type": "Organization",
        "name": "CIBIL Repair",
        "alternateName": ["CIBIL Repair India", "CIBIL"],
      ...
      "url": "https://cibilrepair.in/service/enterprise",
      "areaServed": "IN",
      "serviceType": "Legal Credit Repair",
      "offers": {
        "@type": "Offer",
        "priceCurrency": "INR",
        "price": "0",
      ...
      "audience": {
        "@type": "Audience",
        "name": "Companies, LLPs, Proprietorships, and individuals with complex legal entries"
      },
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://cibilrepair.in/service/enterprise"
      }
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "Enterprise — Legal & Complex Cases | CIBIL Repair",
      "description": "Remove commercial CIBIL entries, legal suits, and complex credit issues. Expert legal team handles court documentation, FIR support, and full credit profile protection.",
      "url": "https://cibilrepair.in/service/enterprise",
      "mainEntity": {
        "@type": "Service",
        "name": "Enterprise — Legal & Complex Cases",
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 3,
          "name": "Enterprise — Legal & Complex Cases",
          "item": "https://cibilrepair.in/service/enterprise"
        }
      ]
    }
    </script>
    ...
    <!-- ============================================================
     SCHEMA 7: PRODUCT/OFFER (ENTERPRISE)
     ============================================================ -->
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
...
.ck-icon{width:64px;height:64px;border-radius:16px;display:flex;align-items:center;justify-content:center;font-size:26px;margin:0 auto 18px;background:linear-gradient(135deg,#f0e8ff,#ddd0ff);transition:transform .3s}
...
/* ============================================================
   SERVICE LAYOUT — 2-col: content + custom quote card
   ============================================================ */
...
.price{font-family:'Bebas Neue',sans-serif;font-size:2.8rem;color:var(--gold);line-height:1;letter-spacing:2px}
...
.save-tag{display:inline-block;background:#fff8e0;border:1px solid rgba(245,197,24,.3);color:#b45309;font-family:'Montserrat',sans-serif;font-size:.7rem;font-weight:700;padding:2px 10px;border-radius:20px;margin-top:5px}
...
.pay-btn{width:100%;padding:15px;background:linear-gradient(135deg,var(--gold),var(--gold2));color:#fff;border:none;border-radius:50px;font-size:.95rem;font-weight:800;cursor:pointer;transition:.3s;margin-top:6px;font-family:'Montserrat',sans-serif;letter-spacing:.3px;display:flex;align-items:center;justify-content:center;gap:9px}
.pay-btn:hover:not(:disabled){transform:translateY(-2px);box-shadow:0 8px 24px rgba(245,197,24,.45)}
...
.secure-badge i{color:var(--gold);margin-right:4px}
...
<section class="page-hero">
  ...
  <div class="ph-inner">
    <div>
      <div class="ph-badge r"><div class="ph-dot"></div> Enterprise — Legal & Complex Cases</div>
      <h1 class="ph-h1 r">
        <span class="w">LEGAL</span>
        <span class="g">COMPLEX</span>
        <span class="y">CASES</span>
      </h1>
      <p class="ph-sub r">Commercial CIBIL, legal suits, court cases, and complex credit issues — handled by our in-house legal team with full court documentation, FIR support, and 24/7 priority updates. For companies, LLPs, proprietorships, and individuals with legal entries.</p>
      <div class="ph-acts r">
        <button class="btn-primary" onclick="document.getElementById('fullName').focus();document.getElementById('fullName').scrollIntoView({behavior:'smooth',block:'center'})">
          <i class="fas fa-building"></i> Get a Custom Quote
        </button>
        <a href="#what-we-fix" class="btn-ghost"><i class="fas fa-arrow-down"></i> See How We Help</a>
      </div>
      <div class="ph-trust r">
        <div class="pht"><span class="pht-n">98%</span><div class="pht-l">Success Rate</div></div>
        <div class="pht"><span class="pht-n">Custom</span><div class="pht-l">Tailored Timeline</div></div>
        <div class="pht"><span class="pht-n">4</span><div class="pht-l">Bureaus Updated</div></div>
        <div class="pht"><span class="pht-n">24/7</span><div class="pht-l">Priority Support</div></div>
      </div>
    </div>
    ...
    <div class="ph-card r">
      <div class="ph-card-header">
        ...
        <div class="ph-live">⚖️ Expert Legal Team</div>
      </div>
      <div class="milestones">
        <div class="ms"><div class="ms-icon y">🏛️</div><div class="ms-text"><div class="ms-title">Court Documentation</div><div class="ms-sub">Orders, decrees &amp; settlement deeds</div></div><div class="ms-val y">Secured</div></div>
        <div class="ms"><div class="ms-icon b">⚖️</div><div class="ms-text"><div class="ms-title">Legal Dispute Filing</div><div class="ms-sub">Strong notices filed across all 4 bureaus</div></div><div class="ms-val b">All 4</div></div>
        <div class="ms"><div class="ms-icon r">🛡️</div><div class="ms-text"><div class="ms-title">Police FIR Support</div><div class="ms-sub">Identity theft &amp; fraud complaint filing</div></div><div class="ms-val r">Covered</div></div>
        <div class="ms"><div class="ms-icon g">📈</div><div class="ms-text"><div class="ms-title">Full Profile Protection</div><div class="ms-sub">Complete credit profile secured post-resolution</div></div><div class="ms-val g">Secured</div></div>
      </div>
    </div>
  </div>
</section>
...
<div class="breadcrumb-bar">
  <div class="bc-inner">
    ...
    <span>›</span>
    <span class="current">Enterprise — Legal & Complex Cases</span>
  </div>
</div>
...
<div class="stats-band">
  <div class="sb-grid">
    <div class="sb-item r"><span class="sb-num gold" data-target="95" data-s="%">0</span><div class="sb-desc">Complex Cases Resolved</div></div>
    <div class="sb-item r"><span class="sb-num green" data-target="100" data-s="%">0</span><div class="sb-desc">Legal Team Success Rate</div></div>
    <div class="sb-item r"><span class="sb-num blue" data-target="24/7" data-s="">0</span><div class="sb-desc">Priority Support</div></div>
    <div class="sb-item r"><span class="sb-num gold" data-target="4" data-s=" Bureaus">0</span><div class="sb-desc">All Bureaus Covered</div></div>
  </div>
</div>
...
<section class="process-sec">
  <div class="W">
    <div class="sh r">
      ...
      <p class="ss" style="color:rgba(255,255,255,.5)">Six expert-led steps from legal document collection to confirmed resolution across all four credit bureaus.</p>
    </div>
    <div class="steps-grid">
      <div class="step-card r">
        <div class="step-num-wrap"><i class="fas fa-file-contract"></i></div>
        <div class="step-title">Legal Document Review</div>
        <p class="step-desc">We review court orders, settlement deeds, and all legal documentation to build your case.</p>
      </div>
      <div class="step-card r">
        <div class="step-num-wrap" style="background:linear-gradient(135deg,var(--blue),var(--blue2))"><i class="fas fa-gavel"></i></div>
        <div class="step-title">Court Documentation</div>
        <p class="step-desc">We help collect final court orders, decrees, or dismissal documents — the key legal proofs.</p>
      </div>
      <div class="step-card r">
        ...
        <p class="step-desc">Bureau-specific dispute notices citing the court order, RBI guidelines, and CIC Act 2005.</p>
      </div>
      <div class="step-card r">
      ...
      <div class="step-card r">
        ...
        <p class="step-desc">Banking Ombudsman, RBI Consumer Protection, and court direction if bureau refuses.</p>
      </div>
      <div class="step-card r">
        <div class="step-num-wrap" style="background:linear-gradient(135deg,#7c3aed,#9333ea)"><i class="fas fa-check-double"></i></div>
        <div class="step-title">Confirm &amp; Protect</div>
        <p class="step-desc">Legal entries removed, reports confirmed across all bureaus, and your profile fully secured.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="sec" id="what-we-fix">
  <div class="W">
    <div class="sh r">
      <div class="pill pill-green">✅ Legal Scope</div>
      <h2 class="st">What We <em>Resolve</em></h2>
      <p class="ss">Every type of legal and complex credit issue handled with a tailored legal strategy — no case is too complex.</p>
    </div>
    <div class="check-grid" style="margin-bottom:80px">
      <div class="ck r">
        <div class="ck-icon">🏛️</div>
        <div class="ck-name">Commercial CIBIL</div>
        <p class="ck-desc">Commercial credit reports for companies, LLPs, and proprietorships — including business loan defaults and corporate credit issues.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">⚖️</div>
        <div class="ck-name">Suit Filed Removal</div>
        <p class="ck-desc">Legal suits, court cases, and decree entries on your credit report — removed using court documentation and legal dispute filings.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">🤝</div>
        <div class="ck-name">Complex Credit Issues</div>
        <p class="ck-desc">Multiple negative entries, fraud cases, identity theft, and any complex credit situation requiring dedicated legal intervention.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">📋</div>
        <div class="ck-name">Legal Document Help</div>
        <p class="ck-desc">Court order collection, decree verification, settlement deed review — all documentation support provided.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">🛡️</div>
        <div class="ck-name">Police FIR Support</div>
        <p class="ck-desc">Identity theft and fraud complaint filing support with police authorities — covered under our enterprise service.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">🏢</div>
        <div class="ck-name">Organisation Credit Fix</div>
        <p class="ck-desc">Companies, LLP, proprietorship, partnership firms, or any organisation with credit report issues — we handle it all.</p>
      </div>
    </div>

    <!-- ============================================================
         2-COLUMN: CONTENT + CUSTOM QUOTE CARD
         ============================================================ -->
    <div class="service-layout">
      <div class="service-content">

        <h2>📖 What is Enterprise Legal Clearance?</h2>
        <p>Legal entries on your credit report — suit filed, court cases, commercial CIBIL issues — are the most complex and damaging remarks possible. They require specialized legal expertise, court documentation, and strategic escalation to the Banking Ombudsman, RBI, and even the courts themselves.</p>
        <p>The Enterprise Plan is our premium service, designed for individuals and organisations facing complex credit issues that require dedicated legal intervention. Our in-house legal team handles everything from document collection to court direction, ensuring your credit profile is fully protected.</p>

        <div class="inline-stats">
          <div class="istat r"><span class="istat-n">95%</span><div class="istat-l">Of complex cases need legal intervention</div></div>
          <div class="istat r"><span class="istat-n">100%</span><div class="istat-l">Legal team success rate</div></div>
          <div class="istat r"><span class="istat-n">24/7</span><div class="istat-l">Priority case updates</div></div>
        </div>

        <h2>🔍 Complex Issues We Handle</h2>
        <div class="impact-grid">
          <div class="impact-item"><i class="fas fa-building"></i><span>Commercial CIBIL for companies &amp; LLPs</span></div>
          <div class="impact-item"><i class="fas fa-gavel"></i><span>Legal suits &amp; court case entries</span></div>
          <div class="impact-item"><i class="fas fa-shield-alt"></i><span>Identity theft &amp; fraud cases</span></div>
          <div class="impact-item"><i class="fas fa-file-alt"></i><span>Multiple wrong entries across bureaus</span></div>
          <div class="impact-item"><i class="fas fa-ban"></i><span>Complex settled &amp; written-off accounts</span></div>
          <div class="impact-item"><i class="fas fa-user-slash"></i><span>Profile mix-ups &amp; duplicate profiles</span></div>
        </div>

        <h2>🎯 What You Receive</h2>
        <p>Our Enterprise Plan is a complete legal protection service — not just a dispute process:</p>
        <ul class="report-list">
          <li><span>🏛️</span> Commercial CIBIL &amp; legal entry removal</li>
          <li><span>📋</span> Court document collection assistance</li>
          <li><span>⚖️</span> Legal dispute filing with all 4 bureaus</li>
          <li><span>🛡️</span> Police FIR complaint filing support</li>
          <li><span>🏦</span> Banking Ombudsman &amp; RBI filing</li>
          <li><span>🏛️</span> Court direction if bureau refuses</li>
          <li><span>📋</span> Updated credit reports confirming removal</li>
          <li><span>📞</span> 24/7 priority case updates</li>
          <li><span>🔒</span> Full credit profile secured post-resolution</li>
          <li><span>💰</span> 100% satisfaction guarantee</li>
        </ul>

        <h2>✅ Benefits of Enterprise Clearance</h2>
        <div class="benefits-grid">
          ...
          <div class="benefit-item"><strong>🏢 Organisation Credit Fix</strong><span>Companies, LLPs, proprietorships — all types of organisations covered</span></div>
          <div class="benefit-item"><strong>🛡️ Identity Theft Protection</strong><span>Police FIR support and fraud removal assistance included</span></div>
          <div class="benefit-item"><strong>🔒 Full Profile Security</strong><span>Your credit profile is fully secured and protected post-resolution</span></div>
          <div class="benefit-item"><strong>🏠 Individual Complex Cases</strong><span>Legal suits, court cases, and complex individual credit issues handled</span></div>
        </div>

        <h2>❓ Frequently Asked Questions</h2>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">What types of organisations do you help? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">Companies (private and public), LLPs, proprietorship firms, partnership firms, and any other organisation type with credit report issues. We handle both individual and commercial CIBIL reports.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">Do I need my own lawyer for this? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">No. Our in-house legal team handles all drafting, filings, and escalations. You only need to provide any court documents you already have (if any). If you don't have the court orders, we help you obtain them through the relevant court registry.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">What if the bank or bureau refuses to remove the entry? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">Refusal triggers our escalation protocol: we file a formal complaint with the Banking Ombudsman, then with RBI Consumer Protection. If those avenues don't resolve it, we approach the court for a specific direction ordering the bureau to update the report.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">How much does the Enterprise Plan cost? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">The Enterprise Plan is custom-priced based on your specific case complexity. We provide a detailed quote after a free consultation where we assess your credit report, legal documents, and the scope of work required.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">What is police FIR support? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">If your case involves identity theft or fraud, we help you file a formal police complaint (FIR). The FIR is a powerful legal document that forces bureaus and lenders to remove fraudulent entries from your credit report.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">Is my personal and legal data safe with CIBIL Repair? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">Absolutely. All data is encrypted with 256-bit SSL. We are fully compliant with the IT Act 2000 and DPDP Act 2023. Your court documents and personal information are never shared with third parties and are used solely for filing your dispute.</div>
        </div>
      ...
      <div>
        <div class="payment-card r">
          <div class="price-badge">
            ...
            <div class="gst-note">Tailored to your specific case complexity</div>
            <span class="save-tag">⚖️ In-House Legal Team Included</span>
          </div>

          <ul class="features-list">
            <li><i class="fas fa-check-circle"></i> Commercial CIBIL removal</li>
            <li><i class="fas fa-check-circle"></i> Legal suit &amp; court case removal</li>
            <li><i class="fas fa-check-circle"></i> Court document collection</li>
            <li><i class="fas fa-check-circle"></i> Legal dispute filing</li>
            <li><i class="fas fa-check-circle"></i> Police FIR support</li>
            ...
            <li><i class="fas fa-check-circle"></i> Court direction if needed</li>
            <li><i class="fas fa-check-circle"></i> 24/7 priority case updates</li>
            <li><i class="fas fa-check-circle"></i> Full credit profile protection</li>
          ...
          <form id="paymentForm">
            ...
            <div class="form-group">
              ...
              <input type="text" id="orgName" placeholder="Enter organisation name">
            </div>
            <button type="submit" class="pay-btn" id="payBtn">
              <i class="fas fa-gavel"></i> Request a Custom Quote
            </button>
          </form>
...
<section class="trust-sec">
  <div class="W">
    ...
    <div class="trust-grid">
      ...
      <div class="trust-card r"><div class="tci y">💰</div><h4>100% Satisfaction Guarantee</h4><p>If we cannot resolve your complex case, you receive a full refund — no questions asked.</p></div>
...
<section class="cta-sec">
  <div class="W">
    <div class="cta-inner r">
      <h2 class="cta-h">Have a Complex Credit or <em>Legal Issue?</em></h2>
      <p class="cta-p">Talk to our legal expert before you pay anything. Free guidance, no obligation — real answers about your specific case.</p>
      <div class="cta-acts">
        <button class="btn-primary" onclick="openModal()"><i class="fas fa-rocket"></i> Get Free Consultation</button>
        <a href="https://wa.me/919905482503?text=Hi%2C%20I%20need%20help%20with%20enterprise%20legal%20clearance%20on%20my%20CIBIL%20report" class="btn-ghost" target="_blank"><i class="fab fa-whatsapp"></i> Chat on WhatsApp</a>
      ...
      <div class="cta-trust">
        ...
        <div class="ct"><i class="fas fa-check-circle"></i> 100% satisfaction guarantee</div>
      </div>
    </div>
  </div>
</section>
...
<!-- WhatsApp FAB -->
<a href="https://wa.me/919905482503?text=Hi%2C%20I%20need%20help%20with%20enterprise%20legal%20clearance%20on%20my%20CIBIL%20report" class="wa" target="_blank" aria-label="WhatsApp"><i class="fab fa-whatsapp"></i></a>
...
<div class="modal-bg" id="modal">
  <div class="modal-box">
    ...
    <h3 class="m-h">Free Legal Consultation</h3>
    <p class="m-s">Get expert legal advice on your complex credit case. Our legal team contacts you within 2 hours.</p>
...
const SERVICE = { id: 9, name: 'Enterprise — Legal & Complex Cases', amount: 0, caseNo: 'ENT' + Date.now() };
...
function submitLead() {
    ...
    const msg = encodeURIComponent('Hi! I want a free consultation for enterprise legal clearance on my CIBIL report.\n\nName: ' + n + '\nPhone: ' + p + (em ? '\nEmail: ' + em : ''));
...
function hideLoading() { 
    if (payBtn) { payBtn.disabled = false; payBtn.innerHTML = '<i class="fas fa-gavel"></i> Request a Custom Quote'; }
}
...
if (form) {
    form.addEventListener('submit', async function(e) {
        ...
        const options = {
            key: RAZORPAY_KEY,
            amount: 100 * 100, // ₹100 token charge for consultation
            currency: 'INR',
            name: 'CIBIL Repair',
            description: 'Enterprise — Custom Quote Consultation',
            order_id: orderId,
            ...
            handler: function(response) {
                hideLoading();
                showResultModal(true, 'Consultation Requested!', `Thank you ${fullName}! Your consultation request has been received. Our legal team will contact you within 24 hours to discuss your case and provide a custom quote.`, response.razorpay_payment_id);
                form.reset();
            },
            modal: { 
                ondismiss: function() { 
                    hideLoading(); 
                    showResultModal(false, 'Request Cancelled', 'You cancelled the consultation request. Please try again whenever you are ready.'); 
                } 
            }
        };
        ...
        rzp.on('payment.failed', function(response) { 
            hideLoading(); 
            showResultModal(false, 'Request Failed', response.error.description || 'Something went wrong. Please try again.'); 
        });
    });
}
</script>
