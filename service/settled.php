...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_SERVER['HTTP_X_REQUESTED_WITH'])) {
    ...
    $service_id   = (int)($data['service_id'] ?? 2);
    $service_name = 'Settled Clearance';
    $amount       = 12999;
...
<head>
  ...
  <meta name="description" content="Convert settled accounts to closed status on your CIBIL report and improve your credit score by 50-100 points. 98% success rate. Money-back guarantee.">
  <meta name="keywords" content="settled account removal, CIBIL settled status, settlement removal, settled to closed, credit report settlement, CIBIL repair">
  <meta name="author" content="CIBIL Repair">
  <title>Settled Clearance — Convert Settled to Closed on CIBIL | CIBIL Score Repair</title>
  <link rel="canonical" href="https://cibilrepair.in/service/settled">
  ...
  <!-- ============================================================
    ...
    <!-- ============================================================
     SCHEMA 4: SERVICE (SETTLED CLEARANCE)
     ============================================================ -->
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Settled → Closed Conversion",
      "image": "https://cibilrepair.in/images/services/settled.jpg",
      "description": "Convert 'Settled' status to 'Closed' across all four credit bureaus. Dramatically boosts loan eligibility and creditworthiness through direct creditor negotiation and NOC procurement.",
      "provider": {
        "@type": "Organization",
        "name": "CIBIL Repair",
        "alternateName": ["CIBIL Repair India", "CIBIL"],
      ...
      "url": "https://cibilrepair.in/service/settled",
      "areaServed": "IN",
      ...
      "audience": {
        "@type": "Audience",
        "name": "Individuals with settled accounts on their credit report"
      },
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://cibilrepair.in/service/settled"
      }
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "Settled Clearance — Convert Settled to Closed on CIBIL | CIBIL Repair",
      "description": "Convert settled accounts to closed status on your CIBIL report and improve your credit score by 50-100 points. 98% success rate. Money-back guarantee.",
      "url": "https://cibilrepair.in/service/settled",
      "mainEntity": {
        "@type": "Service",
        "name": "Settled → Closed Conversion",
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Settled Clearance",
          "item": "https://cibilrepair.in/service/settled"
        }
      ]
    }
    </script>
    ...
    <!-- ============================================================
     SCHEMA 7: PRODUCT/OFFER (SETTLED CLEARANCE)
     ============================================================ -->
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Product",
      "name": "Settled Clearance — Settled to Closed Conversion",
      "description": "Convert 'Settled' status to 'Closed' across all four credit bureaus. Dramatically boosts loan eligibility and creditworthiness through direct creditor negotiation and NOC procurement.",
      "image": "https://cibilrepair.in/images/services/settled.jpg",
      "brand": {
        "@type": "Brand",
    ...
    <li class="nl-item">
      ...
      <div class="dd dd-wide">
        ...
        <div class="dd-col">
          ...
          <a href="/service/settled.php" style="color:var(--blue2);background:#f0f7ff"><i class="fas fa-handshake"></i><div><strong>Settled → Closed</strong><span>Convert settled → closed</span></div></a>
...
<section class="page-hero">
  ...
  <div class="ph-inner">
    <div>
      <div class="ph-badge r"><div class="ph-dot"></div> Settled Clearance — All 4 Bureaus</div>
      <h1 class="ph-h1 r">
        <span class="w">SETTLED</span>
        <span class="g">CLEARANCE</span>
        <span class="y">SCORE BOOST</span>
      </h1>
      <p class="ph-sub r">A "Settled" remark on your CIBIL report drops your score by 50–100 points and blocks loan approvals for years. We legally convert it to "Closed" across all 4 bureaus — without you paying a single rupee extra to the bank.</p>
      <div class="ph-acts r">
        <button class="btn-primary" onclick="document.getElementById('fullName').focus();document.getElementById('fullName').scrollIntoView({behavior:'smooth',block:'center'})">
          <i class="fas fa-handshake"></i> Clear My Settlement Now
        </button>
      ...
      <div class="ph-trust r">
        ...
        <div class="pht"><span class="pht-n">8000+</span><div class="pht-l">Accounts Cleared</div></div>
      </div>
    </div>
    ...
    <div class="ph-card r">
      ...
      <div class="milestones">
        <div class="ms"><div class="ms-icon y">📄</div><div class="ms-text"><div class="ms-title">No Dues Certificate</div><div class="ms-sub">NDC secured from lender on your behalf</div></div><div class="ms-val y">Secured</div></div>
        <div class="ms"><div class="ms-icon g">🔄</div><div class="ms-text"><div class="ms-title">Status Update</div><div class="ms-sub">Settled → Closed across all bureaus</div></div><div class="ms-val g">All 4</div></div>
        <div class="ms"><div class="ms-icon b">⚖️</div><div class="ms-text"><div class="ms-title">Legal Escalation</div><div class="ms-sub">Ombudsman & RBI filing if needed</div></div><div class="ms-val b">Covered</div></div>
...
<div class="breadcrumb-bar">
  <div class="bc-inner">
    ...
    <span>›</span>
    <span class="current">Settled Clearance</span>
  </div>
</div>
...
<div class="stats-band">
  <div class="sb-grid">
    <div class="sb-item r"><span class="sb-num gold" data-target="80" data-s="%">0</span><div class="sb-desc">Lenders Auto-Reject Settled Accounts</div></div>
    <div class="sb-item r"><span class="sb-num green" data-target="100" data-s=" pts">0</span><div class="sb-desc">Avg Score Gain After Clearance</div></div>
...
<section class="process-sec">
  <div class="W">
    <div class="sh r">
      ...
      <h2 class="st" style="color:#fff">Our <em>Clearance Process</em></h2>
      <p class="ss" style="color:rgba(255,255,255,.5)">Six expert-led steps from settlement verification to confirmed status update across all four bureaus.</p>
    </div>
    <div class="steps-grid">
      <div class="step-card r">
        <div class="step-num-wrap"><i class="fas fa-file-contract"></i></div>
        <div class="step-title">Verify Settlement</div>
        <p class="step-desc">We review your settlement deed, payment proof, and bureau report to confirm eligibility.</p>
      </div>
      <div class="step-card r">
        <div class="step-num-wrap" style="background:linear-gradient(135deg,var(--blue),var(--blue2))"><i class="fas fa-certificate"></i></div>
        <div class="step-title">Obtain NDC / NOC</div>
        <p class="step-desc">We liaise with your bank or NBFC to secure a No Dues Certificate — the key document.</p>
      </div>
      <div class="step-card r">
        <div class="step-num-wrap" style="background:linear-gradient(135deg,#d97706,var(--gold2))"><i class="fas fa-pen-alt"></i></div>
        <div class="step-title">Draft Legal Letters</div>
        <p class="step-desc">Bureau-specific dispute notices drafted with NDC and settlement proof attached.</p>
      </div>
      <div class="step-card r">
      ...
      <div class="step-card r">
        ...
        <p class="step-desc">Status updated to "Closed", reports confirmed across all bureaus, summary sent to you.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="sec" id="what-we-fix">
  <div class="W">
    <div class="sh r">
      ...
      <p class="ss">Every type of settled account situation handled with tailored legal strategy — nothing is left unresolved.</p>
    </div>
    <div class="check-grid" style="margin-bottom:80px">
      <div class="ck r">
        <div class="ck-icon">🏦</div>
        <div class="ck-name">Bank Loan Settlements</div>
        <p class="ck-desc">Personal loans, home loans, auto loans, and business loans settled with the bank — all eligible for status upgrade to Closed.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">💳</div>
        <div class="ck-name">Credit Card Settlements</div>
        <p class="ck-desc">Credit card outstanding settled for less than the full amount — one of the most common and damaging remarks we fix.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">🏢</div>
        <div class="ck-name">NBFC &amp; Fintech Loans</div>
        <p class="ck-desc">Loans from NBFCs, digital lenders, and microfinance institutions settled for reduced amounts — all covered under our service.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">📋</div>
        <div class="ck-name">No Dues Certificate Help</div>
        <p class="ck-desc">If your lender hasn't issued an NDC yet or is delaying — we follow up and escalate until the certificate is obtained legally.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">⚖️</div>
        <div class="ck-name">Lender Refusal Escalation</div>
        <p class="ck-desc">When banks refuse to update the status even after settlement, we escalate to Banking Ombudsman and RBI under CIC Act 2005.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">📊</div>
        <div class="ck-name">Multi-Account Clearance</div>
        <p class="ck-desc">Multiple settled accounts across different lenders? We handle all of them simultaneously — one fee, complete resolution.</p>
      </div>
    </div>
    ...
    <div class="service-layout">
      <div class="service-content">
        ...
        <h2>📖 What is Settled Clearance?</h2>
        <p>When you repay a loan or credit card for less than the full outstanding amount — often as part of a one-time settlement (OTS) — the lender marks your account as "Settled" in your credit report. This single word is a severe black mark. It signals to every future lender that you defaulted on your original commitment.</p>
        <p>Our Settled Clearance service legally converts this remark to "Closed" — the status that shows the account was fully resolved — by working with your lender, the credit bureaus, and if necessary, the Banking Ombudsman and RBI. You do not need to pay any additional amount to the bank. This is a documentation and dispute process, not a repayment process.</p>

        <div class="inline-stats">
          <div class="istat r"><span class="istat-n">80%</span><div class="istat-l">Banks reject settled account holders</div></div>
          <div class="istat r"><span class="istat-n">+100 pts</span><div class="istat-l">Avg score gain after clearance</div></div>
          <div class="istat r"><span class="istat-n">30 Days</span><div class="istat-l">Fastest resolution in India</div></div>
        </div>

        <h2>🔍 How a Settled Account Hurts You</h2>
        <div class="impact-grid">
          <div class="impact-item"><i class="fas fa-chart-line fa-rotate-180"></i><span>50–100 point score drop</span></div>
          <div class="impact-item"><i class="fas fa-ban"></i><span>80% of banks auto-reject</span></div>
        ...
        <p>Our settled clearance service is a complete end-to-end legal process — not just a letter:</p>
        <ul class="report-list">
          <li><span>📄</span> No Dues Certificate obtained from your lender</li>
          <li><span>✅</span> Status updated from Settled → Closed across all 4 bureaus</li>
          ...
          <li><span>📋</span> Updated credit reports confirming status change</li>
        ...
        <h2>✅ Benefits of Settled Clearance</h2>
        <div class="benefits-grid">
          <div class="benefit-item"><strong>📈 Massive Score Boost</strong><span>Up to 100 points increase once settled remark is removed</span></div>
          ...
          <div class="benefit-item"><strong>💰 No Extra Payment Needed</strong><span>You do NOT pay any more to the bank. This is a documentation fix</span></div>
          <div class="benefit-item"><strong>🏠 Home Loan Eligibility</strong><span>Major banks approve home loans only after settled remark removal</span></div>
          <div class="benefit-item"><strong>📊 True Credit History</strong><span>Your report will reflect the account as closed — not defaulted</span></div>
        </div>

        <h2>❓ Frequently Asked Questions</h2>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">Can a settled account be removed completely from my CIBIL report? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">The "Settled" remark can be upgraded to "Closed" in most cases. After 7 years from the date of settlement, it must be automatically removed. In certain cases where the settlement was done in full good faith with proper documentation, we also attempt early removal — though the primary and most reliable outcome is status conversion to Closed.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">Do I need to pay any more money to the bank to get this done? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">No. Our service is a documentation and legal dispute process. You have already settled the account. Our job is to ensure the credit bureaus reflect the correct status ("Closed") using the settlement proof and NDC you already have — or that we obtain for you. No additional payment to the bank is required or requested.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">How long does the settled clearance process take? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">Most cases are resolved within 30–45 working days. Each bureau is legally required to respond within 30 days under CIC Act 2005. We file simultaneously with all 4 bureaus and follow up daily. If the bank or bureau delays, we escalate to the Ombudsman immediately to keep timelines tight.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">What if the bank refuses to issue a No Dues Certificate? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">This is very common. Banks often delay or deny NDC requests. We escalate this directly to the bank's nodal officer, then to the Banking Ombudsman, and finally to RBI Consumer Protection if needed. Under CIC Regulations, lenders are legally required to update credit records after settlement — we enforce this on your behalf.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">What if I have multiple settled accounts? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">We handle multiple settled accounts simultaneously under our service. All settled entries — across different lenders and bureaus — are addressed in a single engagement. Contact us for a case-specific assessment before purchasing if you have more than 3 settled accounts.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
      ...
      <div>
        <div class="payment-card r">
          <div class="price-badge">
            <div class="price">₹12,999 <small>+ GST</small></div>
            <div class="gst-note">18% GST applicable — total ₹15,339</div>
            <span class="save-tag">⚡ Up to 100 Points Score Boost</span>
          </div>

          <ul class="features-list">
            <li><i class="fas fa-check-circle"></i> Convert Settled → Closed status</li>
            <li><i class="fas fa-check-circle"></i> No Dues Certificate assistance</li>
            <li><i class="fas fa-check-circle"></i> Legal notice &amp; dispute drafting</li>
          ...
          <form id="paymentForm">
            ...
            <button type="submit" class="pay-btn" id="payBtn">
              <i class="fas fa-lock"></i> Pay ₹12,999 + GST &amp; Clear My Settlement
            </button>
          </form>
...
<section class="trust-sec">
  <div class="W">
    ...
    <div class="trust-grid">
      ...
      <div class="trust-card r"><div class="tci y">💰</div><h4>Money-Back Guarantee</h4><p>If we cannot convert your settled account to closed status, you receive a full refund — no questions asked.</p></div>
...
<section class="cta-sec">
  <div class="W">
    <div class="cta-inner r">
      <h2 class="cta-h">Have a Settled Account Blocking Your <em>Loan Approvals?</em></h2>
      <p class="cta-p">Talk to our settled clearance expert before you pay anything. Free guidance, no obligation — real answers about your specific case.</p>
      <div class="cta-acts">
        <button class="btn-primary" onclick="openModal()"><i class="fas fa-rocket"></i> Get Free Consultation</button>
        <a href="https://wa.me/919905482503?text=Hi%2C%20I%20need%20help%20with%20settled%20clearance%20on%20my%20CIBIL%20report" class="btn-ghost" target="_blank"><i class="fab fa-whatsapp"></i> Chat on WhatsApp</a>
      ...
      <div class="cta-trust">
        ...
        <div class="ct"><i class="fas fa-check-circle"></i> No extra payment to bank</div>
...
<!-- WhatsApp FAB -->
<a href="https://wa.me/919905482503?text=Hi%2C%20I%20need%20help%20with%20settled%20clearance%20on%20my%20CIBIL%20report" class="wa" target="_blank" aria-label="WhatsApp"><i class="fab fa-whatsapp"></i></a>
...
<div class="modal-bg" id="modal">
  <div class="modal-box">
    ...
    <h3 class="m-h">Free Settled Clearance Consult</h3>
    <p class="m-s">Get expert advice on clearing your settled account. Our team contacts you within 2 hours.</p>
...
const SERVICE = { id: 2, name: 'Settled Clearance', amount: 12999, caseNo: 'STL' + Date.now() };
...
function submitLead() {
    ...
    const msg = encodeURIComponent('Hi! I want a free consultation for settled clearance on my CIBIL report.\n\nName: ' + n + '\nPhone: ' + p + (em ? '\nEmail: ' + em : ''));
...
function hideLoading() { 
    if (payBtn) { payBtn.disabled = false; payBtn.innerHTML = '<i class="fas fa-lock"></i> Pay ₹12,999 + GST &amp; Clear My Settlement'; }
}
    ...
    form.addEventListener('submit', async function(e) {
        ...
        const options = {
            ...
            handler: function(response) {
                hideLoading();
                showResultModal(true, 'Payment Successful!', `Thank you ${fullName}! Your payment has been completed. Our team will contact you within 24 hours to begin your settled clearance process.`, response.razorpay_payment_id);
                form.reset();
            },
            modal: { 
                ondismiss: function() { 
