...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_SERVER['HTTP_X_REQUESTED_WITH'])) {
    ...
    $service_id   = (int)($data['service_id'] ?? 1);
    $service_name = 'Written Off Clearance';
    $amount       = 14999;
...
<head>
  ...
  <meta name="description" content="Remove written-off accounts from your CIBIL report and improve your credit score by 50-100 points. 98% success rate. Money-back guarantee.">
  <meta name="keywords" content="written off removal, CIBIL written off status, write-off clearance, written off to closed, credit report write-off, CIBIL repair">
  <meta name="author" content="CIBIL Repair">
  <title>Written Off Clearance — Remove Written-Off Status from CIBIL | CIBIL Score Repair</title>
  <link rel="canonical" href="https://cibilrepair.in/service/written-off">
  ...
  <!-- ============================================================
    ...
    <!-- ============================================================
     SCHEMA 4: SERVICE (WRITTEN OFF CLEARANCE)
     ============================================================ -->
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Written Off Clearance — Complete Removal",
      "image": "https://cibilrepair.in/images/services/written-off.jpg",
      "description": "Full legal removal of written-off accounts from credit bureau records using RBI-compliant dispute filing and bank NOC procurement. Includes simultaneous updates across all four bureaus.",
      "provider": {
        "@type": "Organization",
        "name": "CIBIL Repair",
        "alternateName": ["CIBIL Repair India", "CIBIL"],
      ...
      "url": "https://cibilrepair.in/service/written-off",
      "areaServed": "IN",
      ...
      "audience": {
        "@type": "Audience",
        "name": "Individuals with written-off accounts on their credit report"
      },
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://cibilrepair.in/service/written-off"
      }
    }
    </script>
...
<!-- ============================================================
    ...
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "Written Off Clearance — Remove Written-Off Status from CIBIL | CIBIL Repair",
      "description": "Remove written-off accounts from your CIBIL report and improve your credit score by 50-100 points. 98% success rate. Money-back guarantee.",
      "url": "https://cibilrepair.in/service/written-off",
      "mainEntity": {
        "@type": "Service",
        "name": "Written Off Clearance — Complete Removal",
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://cibilrepair.in/service/written-off"
        }
      ]
    }
    </script>
    ...
    <!-- ============================================================
     SCHEMA 7: PRODUCT/OFFER (WRITTEN OFF CLEARANCE)
     ============================================================ -->
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Product",
      "name": "Written Off Clearance — Complete Removal Service",
      "description": "Full legal removal of written-off accounts from all four credit bureaus. Includes time-barred debt validation, legal notice drafting, dispute filing, and Banking Ombudsman escalation if needed.",
      "image": "https://cibilrepair.in/images/services/written-off.jpg",
      "brand": {
        "@type": "Brand",
        "name": "CIBIL Repair"
...
.ph-h1{font-family:'Bebas Neue',sans-serif;font-size:clamp(2.8rem,5.5vw,5rem);line-height:.95;letter-spacing:2px;margin-bottom:18px}
  ...
  <ul class="nav-links">
    ...
    <li class="nl-item">
      ...
      <div class="dd dd-wide">
        ...
        <div class="dd-col">
          <a href="/service/written-off.php" style="color:var(--blue2);background:#f0f7ff"><i class="fas fa-file-alt"></i><div><strong>Complete Removal</strong><span>Removal from Credit bureaus</span></div></a>
...
<section class="page-hero">
  ...
  <div class="ph-inner">
    <div>
      <div class="ph-badge r"><div class="ph-dot"></div> Written-Off Removal — All 4 Bureaus</div>
      <h1 class="ph-h1 r">
        <span class="w">WRITTEN-OFF</span>
        <span class="g">REMOVAL</span>
        <span class="y">SCORE BOOST</span>
      </h1>
      <p class="ph-sub r">A "Written Off" remark on your CIBIL report drops your score by 50–100 points and makes 90% of lenders auto-reject your application. We legally dispute, validate, and remove this entry across all 4 bureaus — restoring your credit history to a clean state.</p>
      <div class="ph-acts r">
        <button class="btn-primary" onclick="document.getElementById('fullName').focus();document.getElementById('fullName').scrollIntoView({behavior:'smooth',block:'center'})">
          <i class="fas fa-file-alt"></i> Remove My Write-off Now
        </button>
      ...
      <div class="ph-trust r">
        ...
        <div class="pht"><span class="pht-n">100 pts</span><div class="pht-l">Avg Score Gain</div></div>
        <div class="pht"><span class="pht-n">5000+</span><div class="pht-l">Accounts Cleared</div></div>
      </div>
    </div>
    ...
    <div class="ph-card r">
      <div class="ph-card-header">
        ...
        <div class="ph-live">Proven Process</div>
      </div>
      <div class="milestones">
        <div class="ms"><div class="ms-icon y">📄</div><div class="ms-text"><div class="ms-title">Time-Barred Validation</div><div class="ms-sub">We check if the write-off exceeds the 7-year limit</div></div><div class="ms-val y">Verified</div></div>
        <div class="ms"><div class="ms-icon g">📝</div><div class="ms-text"><div class="ms-title">Legal Notice Filed</div><div class="ms-sub">Dispute &amp; removal notice sent to all bureaus</div></div><div class="ms-val g">All 4</div></div>
        <div class="ms"><div class="ms-icon b">⚖️</div><div class="ms-text"><div class="ms-title">Ombudsman Escalation</div><div class="ms-sub">RBI filing if lender refuses to act</div></div><div class="ms-val b">Covered</div></div>
        <div class="ms"><div class="ms-icon g">📈</div><div class="ms-text"><div class="ms-title">Score Improvement</div><div class="ms-sub">Up to 100 points expected gain</div></div><div class="ms-val g">30 Days</div></div>
      </div>
    </div>
  </div>
</section>
...
<div class="breadcrumb-bar">
  <div class="bc-inner">
    ...
    <span>›</span>
    <span class="current">Written Off Clearance</span>
  </div>
</div>
...
<div class="stats-band">
  <div class="sb-grid">
    <div class="sb-item r"><span class="sb-num gold" data-target="90" data-s="%">0</span><div class="sb-desc">Lenders Auto-Reject Written-Off Accounts</div></div>
    <div class="sb-item r"><span class="sb-num green" data-target="100" data-s=" pts">0</span><div class="sb-desc">Avg Score Gain After Removal</div></div>
    <div class="sb-item r"><span class="sb-num blue" data-target="30" data-s=" Days">0</span><div class="sb-desc">Fastest Resolution Time</div></div>
...
<section class="process-sec">
  <div class="W">
    <div class="sh r">
      ...
      <h2 class="st" style="color:#fff">Our <em>Removal Process</em></h2>
      <p class="ss" style="color:rgba(255,255,255,.5)">Six expert-led steps from document collection to confirmed removal across all four bureaus.</p>
    </div>
    <div class="steps-grid">
      <div class="step-card r">
        <div class="step-num-wrap"><i class="fas fa-folder-open"></i></div>
        <div class="step-title">Document Collection</div>
        <p class="step-desc">We collect your loan agreement, write-off letter, and full credit report for review.</p>
      </div>
      <div class="step-card r">
        <div class="step-num-wrap" style="background:linear-gradient(135deg,var(--blue),var(--blue2))"><i class="fas fa-pen-alt"></i></div>
        <div class="step-title">Draft Legal Notice</div>
        <p class="step-desc">Bureau- &amp; lender-specific dispute notices drafted with proof of the write-off entry.</p>
      </div>
      <div class="step-card r">
        <div class="step-num-wrap" style="background:linear-gradient(135deg,#d97706,var(--gold2))"><i class="fas fa-search"></i></div>
        <div class="step-title">Validate Write-off</div>
        <p class="step-desc">We check if the write-off is time-barred (7+ years old) or contains reporting errors.</p>
      </div>
      <div class="step-card r">
        <div class="step-num-wrap"><i class="fas fa-paper-plane"></i></div>
        <div class="step-title">File with All 4 Bureaus</div>
        <p class="step-desc">Disputes submitted simultaneously to CIBIL, Equifax, Experian &amp; CRIF with daily follow-up.</p>
      </div>
      <div class="step-card r">
        ...
        <p class="step-desc">Banking Ombudsman and RBI Consumer Protection filing if bureau or bank refuses.</p>
      </div>
      <div class="step-card r">
        ...
        <p class="step-desc">Entry removed or corrected, updated reports confirmed across all bureaus, sent to you.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="sec" id="what-we-fix">
  <div class="W">
    <div class="sh r">
      ...
      <p class="ss">Every type of written-off account situation handled with tailored legal strategy — nothing is left unresolved.</p>
    </div>
    <div class="check-grid" style="margin-bottom:80px">
      <div class="ck r">
        <div class="ck-icon">🏦</div>
        <div class="ck-name">Bank Loan Write-offs</div>
        <p class="ck-desc">Personal loans, home loans, auto loans, and business loans written off by the bank — all eligible for removal or status correction.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">💳</div>
        <div class="ck-name">Credit Card Write-offs</div>
        <p class="ck-desc">Credit card dues written off after prolonged non-payment — one of the most damaging and common entries we fix.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">🏢</div>
        <div class="ck-name">NBFC &amp; Fintech Write-offs</div>
        <p class="ck-desc">Write-offs from NBFCs, digital lenders, and microfinance institutions — all covered under our service.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">⏳</div>
        <div class="ck-name">Time-Barred Debt Validation</div>
        <p class="ck-desc">Write-offs older than 7 years are legally required to be removed. We verify and enforce this on your behalf.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">⚖️</div>
        <div class="ck-name">Lender Refusal Escalation</div>
        <p class="ck-desc">When banks ignore or refuse dispute requests, we escalate to Banking Ombudsman and RBI under CIC Act 2005.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">📊</div>
        <div class="ck-name">Multi-Account Clearance</div>
        <p class="ck-desc">Multiple written-off accounts across different lenders? We handle all of them simultaneously — one fee, complete resolution.</p>
      </div>
    </div>
    ...
    <div class="service-layout">
      <div class="service-content">
        ...
        <h2>📖 What is Written Off Clearance?</h2>
        <p>A "Written Off" status appears when a lender gives up on recovering a debt after prolonged default and closes its books on the account. The entry stays on your credit report for up to 7 years — and often longer due to reporting errors — making it one of the most damaging marks possible. It signals to every future lender that you defaulted and the bank wrote off the loss.</p>
        <p>Our Written Off Clearance service legally disputes and removes this entry — or gets it corrected — by working with the credit bureaus, your lender, and if necessary, the Banking Ombudsman and RBI. There is no requirement to repay the original debt again. This is a documentation and dispute process, not a repayment process.</p>

        <div class="inline-stats">
          <div class="istat r"><span class="istat-n">50–100 pts</span><div class="istat-l">Avg score gain after removal</div></div>
          <div class="istat r"><span class="istat-n">5,000+</span><div class="istat-l">Write-offs cleared</div></div>
          <div class="istat r"><span class="istat-n">30–45 Days</span><div class="istat-l">Fastest resolution in India</div></div>
        </div>

        <h2>🔍 How a Written-Off Account Hurts You</h2>
        <div class="impact-grid">
          <div class="impact-item"><i class="fas fa-chart-line fa-rotate-180"></i><span>50–100 point score drop</span></div>
          <div class="impact-item"><i class="fas fa-ban"></i><span>90% of banks auto-reject</span></div>
          <div class="impact-item"><i class="fas fa-percent"></i><span>2–5% higher interest rates</span></div>
          <div class="impact-item"><i class="fas fa-clock"></i><span>Stays on report for 7 years</span></div>
          ...
          <div class="impact-item"><i class="fas fa-credit-card"></i><span>Credit card limit denied</span></div>
          <div class="impact-item"><i class="fas fa-shield-alt"></i><span>Insurance &amp; rental checks flagged</span></div>
        </div>

        <h2>🎯 What You Receive</h2>
        <p>Our written-off clearance service is a complete end-to-end legal process — not just a letter:</p>
        <ul class="report-list">
          <li><span>📄</span> Time-barred debt validation report</li>
          <li><span>✅</span> Dispute filed with all 4 bureaus on your behalf</li>
          <li><span>📝</span> Formal legal notice sent to the lender</li>
          <li><span>🏦</span> Bank negotiation &amp; direct escalation team</li>
          <li><span>⚖️</span> Banking Ombudsman &amp; RBI filing if bureau refuses</li>
          <li><span>📋</span> Updated credit reports confirming the correction</li>
          <li><span>📞</span> Expert support via WhatsApp &amp; email for 60 days</li>
          <li><span>💰</span> 100% money-back if removal cannot be achieved</li>
        </ul>

        <h2>✅ Benefits of Written Off Clearance</h2>
        <div class="benefits-grid">
          <div class="benefit-item"><strong>📈 Massive Score Boost</strong><span>Up to 100 points increase once the write-off entry is removed</span></div>
          ...
          <div class="benefit-item"><strong>💰 No-Win-No-Fee</strong><span>Full refund if the write-off entry cannot be removed</span></div>
          ...
          <div class="benefit-item"><strong>🏠 Home Loan Eligibility</strong><span>Major banks approve home loans only after write-off removal</span></div>
        </div>

        <h2>❓ Frequently Asked Questions</h2>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">Can a written-off account be removed completely from my CIBIL report? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">Yes, in most cases. By law, written-off entries must be automatically removed after 7 years from the date of write-off. We also dispute and pursue early removal where the entry is time-barred, erroneous, or improperly reported — we've successfully cleared thousands of such cases.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">Do I need to pay the original debt again to get this done? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">No. Our service focuses on correcting the credit remark through documentation and legal dispute. You do not need to pay any additional amount to the lender for the bureau record to be corrected or removed.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">How long does the written-off clearance process take? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">Most cases are resolved within 30–45 working days. Each bureau is legally required to respond to a dispute within 30 days under CIC Act 2005. We file simultaneously with all 4 bureaus and follow up daily, escalating to the Ombudsman immediately if there's a delay.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">What if the bank refuses to update or remove the entry? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">This is common. We escalate directly to the bank's nodal officer, then to the Banking Ombudsman, and finally to RBI Consumer Protection if needed. Under CIC Regulations, lenders are legally required to maintain accurate credit records — we enforce this on your behalf.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">What if I have multiple written-off accounts? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">We handle multiple written-off accounts simultaneously under our service. All write-off entries — across different lenders and bureaus — are addressed in a single engagement. Contact us for a case-specific assessment before purchasing if you have more than 3 written-off accounts.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">Is my data safe with CIBIL Repair? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">Yes, absolutely. All data is encrypted with 256-bit SSL. We are fully compliant with the IT Act 2000 and DPDP Act 2023. Your documents are never shared with third parties or used for any purpose other than filing your dispute with the relevant bureaus and lenders.</div>
        </div>
      ...
      <div>
        <div class="payment-card r">
          <div class="price-badge">
            <div class="price">₹14,999 <small>+ GST</small></div>
            <div class="gst-note">18% GST applicable — total ₹17,699</div>
            <span class="save-tag">⚡ Up to 100 Points Score Boost</span>
          </div>

          <ul class="features-list">
            <li><i class="fas fa-check-circle"></i> Complete written-off account removal</li>
            <li><i class="fas fa-check-circle"></i> Time-barred debt validation</li>
            <li><i class="fas fa-check-circle"></i> Legal notice drafting to bank &amp; bureaus</li>
          ...
          <form id="paymentForm">
            ...
            <button type="submit" class="pay-btn" id="payBtn">
              <i class="fas fa-lock"></i> Pay ₹14,999 + GST &amp; Remove Write-off
            </button>
          </form>
...
<section class="trust-sec">
  <div class="W">
    ...
    <div class="trust-grid">
      ...
      <div class="trust-card r"><div class="tci g">🏦</div><h4>All 4 Bureaus Updated</h4><p>We file corrections simultaneously with CIBIL, Equifax, Experian, and CRIF — no bureau is skipped.</p></div>
      <div class="trust-card r"><div class="tci y">💰</div><h4>Money-Back Guarantee</h4><p>If we cannot remove or correct your written-off entry, you receive a full refund — no questions asked.</p></div>
...
<section class="cta-sec">
  <div class="W">
    <div class="cta-inner r">
      <h2 class="cta-h">Have a Written-Off Account Hurting Your <em>CIBIL Score?</em></h2>
      <p class="cta-p">Talk to our written-off clearance expert before you pay anything. Free guidance, no obligation — real answers about your specific case.</p>
      <div class="cta-acts">
        <button class="btn-primary" onclick="openModal()"><i class="fas fa-rocket"></i> Get Free Consultation</button>
        <a href="https://wa.me/919905482503?text=Hi%2C%20I%20need%20help%20with%20written%20off%20clearance%20on%20my%20CIBIL%20report" class="btn-ghost" target="_blank"><i class="fab fa-whatsapp"></i> Chat on WhatsApp</a>
      ...
      <div class="cta-trust">
        ...
        <div class="ct"><i class="fas fa-check-circle"></i> No extra payment to lender</div>
...
<!-- WhatsApp FAB -->
<a href="https://wa.me/919905482503?text=Hi%2C%20I%20need%20help%20with%20written%20off%20clearance%20on%20my%20CIBIL%20report" class="wa" target="_blank" aria-label="WhatsApp"><i class="fab fa-whatsapp"></i></a>
...
<div class="modal-bg" id="modal">
  <div class="modal-box">
    ...
    <h3 class="m-h">Free Written-Off Clearance Consult</h3>
    <p class="m-s">Get expert advice on removing your written-off account. Our team contacts you within 2 hours.</p>
...
const SERVICE = { id: 1, name: 'Written Off Clearance', amount: 14999, caseNo: 'WOC' + Date.now() };
...
function submitLead() {
    ...
    const msg = encodeURIComponent('Hi! I want a free consultation for written-off clearance on my CIBIL report.\n\nName: ' + n + '\nPhone: ' + p + (em ? '\nEmail: ' + em : ''));
...
function hideLoading() { 
    if (payBtn) { payBtn.disabled = false; payBtn.innerHTML = '<i class="fas fa-lock"></i> Pay ₹14,999 + GST &amp; Remove Write-off'; }
}
    ...
    form.addEventListener('submit', async function(e) {
        ...
        const options = {
            ...
            handler: function(response) {
                hideLoading();
                showResultModal(true, 'Payment Successful!', `Thank you ${fullName}! Your payment has been completed. Our team will contact you within 24 hours to begin your written-off clearance process.`, response.razorpay_payment_id);
                form.reset();
            },
            modal: { 
                ondismiss: function() { 
