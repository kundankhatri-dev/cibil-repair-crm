...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_SERVER['HTTP_X_REQUESTED_WITH'])) {
    ...
    $service_id   = (int)($data['service_id'] ?? 4);
    $service_name = 'Credit Report Analysis';
    $amount       = 5999;
...
<head>
  ...
  <meta name="description" content="Get a professional forensic credit report analysis from CIBIL experts. Identify errors, detect fraud, and get a personalized action plan to boost your score. 98% success rate.">
  <meta name="keywords" content="credit report analysis, CIBIL report check, credit report review, forensic credit audit, credit report errors, dispute identification">
  <meta name="author" content="CIBIL Repair">
  <title>Credit Report Analysis — Forensic Audit &amp; Action Plan | CIBIL Score Repair</title>
  <link rel="canonical" href="https://cibilrepair.in/service/analysis">
  ...
  <link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png">
    ...
    <!-- ============================================================
     SCHEMA 4: SERVICE (CREDIT REPORT ANALYSIS)
     ============================================================ -->
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Credit Report Analysis — Forensic Audit & Action Plan",
      "image": "https://cibilrepair.in/images/services/forensic-audit.jpg",
      "description": "50-point forensic review across all four bureaus uncovering hidden errors, duplicate accounts, identity theft signs, and outdated negative entries. Includes detailed  report and personalised 45-day score improvement plan.",
      "provider": {
        "@type": "Organization",
        "name": "CIBIL Repair",
        "alternateName": ["CIBIL Repair India", "CIBIL"],
      ...
      "url": "https://cibilrepair.in/service/analysis",
      "areaServed": "IN",
      "serviceType": "Credit Audit",
      "offers": {
        "@type": "Offer",
        "priceCurrency": "INR",
        "price": "5999",
      ...
      "audience": {
        "@type": "Audience",
        "name": "Individuals seeking a comprehensive credit report audit"
      },
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://cibilrepair.in/service/analysis"
      }
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "Credit Report Analysis — Forensic Audit & Action Plan | CIBIL Repair",
      "description": "Get a professional forensic credit report analysis from CIBIL experts. Identify errors, detect fraud, and get a personalized action plan to boost your score. 98% success rate.",
      "url": "https://cibilrepair.in/service/analysis",
      "mainEntity": {
        "@type": "Service",
        "name": "Credit Report Analysis — Forensic Audit & Action Plan",
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://cibilrepair.in/service/analysis"
        }
      ]
    }
    </script>
    ...
    <!-- ============================================================
     SCHEMA 7: PRODUCT/OFFER (PAYMENT OFFER)
     ============================================================ -->
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Product",
      "name": "Credit Report Analysis — Forensic Audit",
      "description": "50-point forensic audit across all four credit bureaus. Includes detailed report, dispute letter templates, 30-day action plan, and expert consultation.",
      "image": "https://cibilrepair.in/images/services/forensic-audit.jpg",
      "brand": {
        "@type": "Brand",
        "name": "CIBIL Repair"
...
<style>
/* ============================================================
   ROOT TOKENS — exact match with About Us
   ============================================================ */
:root{
...
/* ============================================================
   PAGE HERO — matches About Us page-hero exactly
   ============================================================ */
.page-hero{
  background:linear-gradient(135deg,#060e1e 0%,#091530 40%,#0d1f45 70%,#071020 100%);
  min-height:60vh;display:flex;align-items:center;
  padding:140px 0 80px;position:relative;overflow:hidden;margin-top:72px;
}
...
/* ============================================================
   WHAT WE CHECK — 3-col cards (matching values-grid)
   ============================================================ */
...
.ck-icon{width:64px;height:64px;border-radius:16px;display:flex;align-items:center;justify-content:center;font-size:26px;margin:0 auto 18px;background:linear-gradient(135deg,#e8fdf2,#b8f0d0);transition:transform .3s}
...
/* ============================================================
   PROCESS STEPS — dark card (matches mission/vision)
   ============================================================ */
...
/* ============================================================
   SERVICE LAYOUT — 2-col content + sticky card
   ============================================================ */
.service-layout{display:grid;grid-template-columns:1fr 420px;gap:50px;margin:0 0 60px}
.service-content h2{
  font-family:'Bebas Neue',sans-serif;font-size:1.9rem;letter-spacing:1.5px;
  color:var(--t1);margin:36px 0 14px;
...
.price{font-family:'Bebas Neue',sans-serif;font-size:3.8rem;font-weight:800;color:var(--green);line-height:1;letter-spacing:2px}
...
.price-badge .orig{font-size:.82rem;color:var(--t3);text-decoration:line-through}
.price-badge .save-tag{display:inline-block;background:#e8fdf2;border:1px solid rgba(34,197,94,.3);color:var(--green2);font-family:'Montserrat',sans-serif;font-size:.7rem;font-weight:700;padding:2px 10px;border-radius:20px;margin-top:5px}
...
.form-group input{
  ...
  font-family:'Open Sans',sans-serif;color:var(--t1);
  background:#fafcff;
}
...
<!-- ============================================================
     NAV — identical structure to About Us
     ============================================================ -->
<nav id="nav">
  ...
  <ul class="nav-links">
    ...
    <li class="nl-item">
      ...
      <div class="dd dd-wide">
        ...
        <div class="dd-col">
          <a href="/service/analysis.php" style="color:var(--blue2);background:#f0f7ff"><i class="fas fa-chart-bar"></i><div><strong>Forensic Audit</strong><span>Credit bureau forensic audit</span></div></a>
...
<section class="page-hero">
  ...
  <div class="ph-inner">
    <div>
      <div class="ph-badge r"><div class="ph-dot"></div> Forensic Credit Audit — All 4 Bureaus</div>
      <h1 class="ph-h1 r">
        <span class="w">CREDIT REPORT</span>
        <span class="g">FORENSIC</span>
        <span class="y">ANALYSIS</span>
      </h1>
      <p class="ph-sub r">A 50-point expert audit across CIBIL, Equifax, Experian &amp; CRIF — pinpointing every hidden error, fraud entry, and score-dragging item with a 30-day action plan to fix them.</p>
      <div class="ph-acts r">
        <button class="btn-primary" onclick="document.getElementById('fullName').focus();document.getElementById('fullName').scrollIntoView({behavior:'smooth',block:'center'})">
          <i class="fas fa-chart-bar"></i> Get My Analysis
        </button>
        <a href="#what-we-check" class="btn-ghost"><i class="fas fa-arrow-down"></i> See What We Audit</a>
      </div>
      <div class="ph-trust r">
        <div class="pht"><span class="pht-n">98%</span><div class="pht-l">Success Rate</div></div>
        <div class="pht"><span class="pht-n">50+</span><div class="pht-l">Point Checklist</div></div>
        <div class="pht"><span class="pht-n">4</span><div class="pht-l">Bureaus Covered</div></div>
        <div class="pht"><span class="pht-n">30</span><div class="pht-l">Day Action Plan</div></div>
      </div>
    </div>
    <div class="ph-card r">
      <div class="ph-card-header">
        <span class="ph-card-title">What You Get</span>
        <div class="ph-live">Instant Delivery</div>
      </div>
      <div class="milestones">
        <div class="ms"><div class="ms-icon g">📋</div><div class="ms-text"><div class="ms-title">50-Point Forensic Audit</div><div class="ms-sub">Every line item manually reviewed</div></div><div class="ms-val g">4 Bureau</div></div>
        <div class="ms"><div class="ms-icon y">📝</div><div class="ms-text"><div class="ms-title">Dispute Letter Templates</div><div class="ms-sub">Ready to use, bureau-specific</div></div><div class="ms-val y">20+ Pages</div></div>
        <div class="ms"><div class="ms-icon b">📅</div><div class="ms-text"><div class="ms-title">30-Day Action Calendar</div><div class="ms-sub">Step-by-step execution plan</div></div><div class="ms-val b">30 Days</div></div>
        <div class="ms"><div class="ms-icon g">📞</div><div class="ms-text"><div class="ms-title">Expert Consultation Call</div><div class="ms-sub">1-on-1 walkthrough of findings</div></div><div class="ms-val g">30 Min</div></div>
      </div>
    </div>
  </div>
</section>
...
<div class="breadcrumb-bar">
  <div class="bc-inner">
    ...
    <span>›</span>
    <span class="current">Credit Report Analysis</span>
  </div>
</div>
...
<div class="stats-band">
  <div class="sb-grid">
    <div class="sb-item r"><span class="sb-num gold" data-target="40" data-s="%">0</span><div class="sb-desc">People Have Report Errors</div></div>
    <div class="sb-item r"><span class="sb-num green" data-target="85" data-s=" pts">0</span><div class="sb-desc">Avg Score Improvement</div></div>
    <div class="sb-item r"><span class="sb-num blue" data-target="30" data-s=" Days">0</span><div class="sb-desc">Typical Resolution Timeline</div></div>
...
<section class="process-sec">
  <div class="W">
    <div class="sh r">
      ...
      <h2 class="st" style="color:#fff">Our <em>Forensic Audit</em> Process</h2>
      <p class="ss" style="color:rgba(255,255,255,.5)">Five expert-led steps from report acquisition to your personalized resolution plan.</p>
    </div>
    <div class="steps-grid">
      <div class="step-card r">
        ...
        <p class="step-desc">We guide you to download your free annual credit reports from all 4 bureaus — no extra cost.</p>
      </div>
      <div class="step-card r">
        ...
        <p class="step-desc">Our team scans every line item using a proprietary 50-point checklist across all bureaus.</p>
      </div>
      <div class="step-card r">
        <div class="step-num-wrap" style="background:linear-gradient(135deg,#d97706,var(--gold2))"><i class="fas fa-tags"></i></div>
        <div class="step-title">Categorize Issues</div>
        <p class="step-desc">Each problem is prioritized — red (critical), yellow (improvable), green (healthy) — by score impact.</p>
      </div>
      <div class="step-card r">
        <div class="step-num-wrap" style="background:linear-gradient(135deg,var(--green),var(--green2))"><i class="fas fa-file-alt"></i></div>
        <div class="step-title">Generate Action Plan</div>
        <p class="step-desc">Detailed 20+ page report with dispute letter templates and a 30-day calendar.</p>
      </div>
      <div class="step-card r">
        <div class="step-num-wrap" style="background:linear-gradient(135deg,#7c3aed,#9333ea)"><i class="fas fa-phone-alt"></i></div>
        <div class="step-title">Expert Consultation</div>
        <p class="step-desc">One-on-one call to walk through findings, explain next steps, and answer all your questions.</p>
      </div>
    </div>
  </div>
</section>
...
<!-- ============================================================
     ...
     ============================================================ -->
<section class="sec" id="what-we-check">
  <div class="W">

    <!-- WHAT WE CHECK GRID -->
    <div class="sh r">
      <div class="pill pill-green">✅ Audit Scope</div>
      <h2 class="st">What We <em>Check</em></h2>
      <p class="ss">A 50-point forensic checklist across all four credit bureaus — leaving nothing to chance.</p>
    </div>
    <div class="check-grid" style="margin-bottom:80px">
      <div class="ck r"><div class="ck-icon">👤</div><div class="ck-name">Personal Information</div><p class="ck-desc">Name spelling, address history, date of birth, and PAN card mismatches that create duplicate profiles.</p></div>
      <div class="ck r"><div class="ck-icon">📊</div><div class="ck-name">Account Status Errors</div><p class="ck-desc">Wrongly marked late payments, accounts showing settled when they should be closed, and incorrect balances.</p></div>
      <div class="ck r"><div class="ck-icon">📋</div><div class="ck-name">Duplicate Entries</div><p class="ck-desc">Same loan or credit card appearing multiple times across bureaus, artificially inflating your debt load.</p></div>
      <div class="ck r"><div class="ck-icon">⏳</div><div class="ck-name">Time-Barred Items</div><p class="ck-desc">Negative accounts older than 7 years that should have been automatically removed from your report.</p></div>
      <div class="ck r"><div class="ck-icon">🚨</div><div class="ck-name">Fraud Detection</div><p class="ck-desc">Unauthorized loans, credit cards, or hard enquiries opened in your name without your knowledge or consent.</p></div>
      <div class="ck r"><div class="ck-icon">💳</div><div class="ck-name">Credit Utilization</div><p class="ck-desc">High card balance ratios dragging your score down — with specific recommendations to optimize each account.</p></div>
    </div>
    ...
    <div class="service-layout">
      <div class="service-content">
        ...
        <h2>📖 What is Credit Report Analysis?</h2>
        <p>A credit report analysis is a forensic-level review of your credit history across all four bureaus — CIBIL, Equifax, Experian, and CRIF. Unlike a basic score check, our experts manually examine each entry to uncover hidden errors, identity theft, duplicate accounts, and outdated negative items that quietly suppress your score.</p>

        <div class="inline-stats">
          <div class="istat r"><span class="istat-n">40%</span><div class="istat-l">People have at least one error</div></div>
          <div class="istat r"><span class="istat-n">50–100</span><div class="istat-l">Avg score points gained after fix</div></div>
          <div class="istat r"><span class="istat-n">30 Days</span><div class="istat-l">Typical resolution timeline</div></div>
        </div>

        <h2>🎯 What You Receive</h2>
        <p>Your personalized analysis report is a 20+ page document color-coded by priority, not a generic printout:</p>
        <ul class="report-list">
          <li><span>🔴</span> Red-flagged errors that need immediate dispute filing</li>
          <li><span>🟡</span> Yellow items improvable through negotiation or goodwill</li>
          <li><span>🟢</span> Green healthy areas — maintain these to protect your score</li>
          <li><span>📝</span> Ready-to-use, bureau-specific dispute letter templates</li>
          <li><span>📅</span> 30-day action calendar with firm deadlines for each step</li>
          <li><span>📞</span> 30-minute expert call to walk through every finding</li>
        </ul>

        <h2>✅ Full Audit Checklist</h2>
        <div class="benefits-grid">
          <div class="benefit-item"><strong>Personal Info Accuracy</strong><span>Name, address, PAN, DOB across all 4 bureaus</span></div>
          <div class="benefit-item"><strong>Payment History</strong><span>Wrongly marked DPD entries and late payment flags</span></div>
          <div class="benefit-item"><strong>Duplicate Accounts</strong><span>Same loan listed multiple times inflating your debt</span></div>
          <div class="benefit-item"><strong>Time-Barred Negatives</strong><span>Accounts >7 years still appearing on your report</span></div>
          <div class="benefit-item"><strong>Fraud &amp; Identity Theft</strong><span>Unauthorized accounts opened in your name</span></div>
          <div class="benefit-item"><strong>Credit Utilization Ratio</strong><span>High card balances and recommendations to optimize</span></div>
          <div class="benefit-item"><strong>Hard Enquiry Audit</strong><span>Unauthorized or excessive hard pulls hurting your score</span></div>
          <div class="benefit-item"><strong>Account Closure Status</strong><span>Settled accounts incorrectly showing as open or active</span></div>
        </div>

        <h2>❓ Frequently Asked Questions</h2>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">Do I need to buy the report separately? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">No. You get one free annual report from each bureau — CIBIL, Equifax, Experian, and CRIF. We guide you step by step to download all four at no extra cost before the audit begins.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">What if no errors are found in my report? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">We still provide a complete score-improvement roadmap based on your financial habits. If genuinely no error exists and no actionable improvement is possible, you receive a 50% refund — no questions asked.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">How long does the analysis take to complete? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">Usually 3–5 working days from report submission. You receive the detailed report by email and can immediately schedule your 1-on-1 expert consultation call at a time that suits you.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">Can I use this to file disputes on my own? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">Absolutely. We provide ready-to-use, bureau-specific dispute letters. You can file them yourself using our action calendar, or engage us to manage the entire dispute process for you.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">Is my personal and financial data safe with you? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">Yes. All data is encrypted with 256-bit SSL. We are fully compliant with the IT Act 2000 and DPDP Act 2023. Your documents are never shared or sold under any circumstances.</div>
        </div>
      </div>
      ...
      <div>
        <div class="payment-card r">
          <div class="price-badge">
            <div class="price">₹5,999 <small>+ GST</small></div>
            <div class="gst-note">18% GST applicable — total ₹7,079</div>
            <div class="save-tag">💰 Money-Back Guarantee Included</div>
          </div>

          <ul class="features-list">
            <li><i class="fas fa-check-circle"></i> Complete 4-bureau report analysis</li>
            <li><i class="fas fa-check-circle"></i> 50-point forensic audit checklist</li>
            <li><i class="fas fa-check-circle"></i> Error &amp; discrepancy identification</li>
            <li><i class="fas fa-check-circle"></i> Ready-to-use dispute letter templates</li>
            <li><i class="fas fa-check-circle"></i> 30-day action plan calendar</li>
            <li><i class="fas fa-check-circle"></i> 30-min expert consultation call</li>
          ...
          <form id="paymentForm">
            ...
            <button type="submit" class="pay-btn" id="payBtn">
              <i class="fas fa-lock"></i> Pay ₹5,999 + GST &amp; Get Analysis
            </button>
          </form>
...
<section class="trust-sec">
  <div class="W">
    ...
    <div class="trust-grid">
      ...
      <div class="trust-card r"><div class="tci g">🏦</div><h4>All 4 Bureaus</h4><p>We audit CIBIL, Equifax, Experian, and CRIF simultaneously — so no error slips through the cracks.</p></div>
      <div class="trust-card r"><div class="tci y">💰</div><h4>Money-Back Guarantee</h4><p>No actionable finding, no charge. If we can't identify improvable issues, you receive a 50% refund.</p></div>
      <div class="trust-card r"><div class="tci y">⭐</div><h4>4.9★ Google Rating</h4><p>Verified reviews from 5,000+ real clients across India — the most trusted credit audit brand in the country.</p></div>
...
<section class="cta-sec">
  <div class="W">
    <div class="cta-inner r">
      <h2 class="cta-h">Still Unsure About Your <em>Credit Report?</em></h2>
      <p class="cta-p">Talk to our credit expert before you pay anything. Free guidance, no obligation — just real answers about your score.</p>
      <div class="cta-acts">
        <button class="btn-primary" onclick="openModal()"><i class="fas fa-rocket"></i> Get Free Consultation</button>
        <a href="https://wa.me/919905482503?text=Hi%2C%20I%20need%20help%20with%20credit%20report%20analysis" class="btn-ghost" target="_blank"><i class="fab fa-whatsapp"></i> Chat on WhatsApp</a>
      ...
      <div class="cta-trust">
        ...
        <div class="ct"><i class="fas fa-check-circle"></i> Report in 3–5 working days</div>
      </div>
    </div>
  </div>
</section>
...
<!-- WhatsApp FAB -->
<a href="https://wa.me/919905482503?text=Hi%2C%20I%20need%20help%20with%20credit%20report%20analysis" class="wa" target="_blank" aria-label="WhatsApp"><i class="fab fa-whatsapp"></i></a>

<!-- ============================================================
     FREE CONSULTATION MODAL (matches About Us)
     ============================================================ -->
<div class="modal-bg" id="modal">
  <div class="modal-box">
    <button class="mc" onclick="closeModal()">×</button>
    <span class="m-ico">🎯</span>
    <h3 class="m-h">Free Credit Consultation</h3>
    <p class="m-s">Get expert advice on your credit report. Our team contacts you within 2 hours.</p>
...
const SERVICE = { id: 4, name: 'Credit Report Analysis', amount: 5999, caseNo: 'CRP' + Date.now() };
...
function submitLead() {
    ...
    const msg = encodeURIComponent('Hi! I want a free CIBIL consultation.\n\nName: ' + n + '\nPhone: ' + p + (em ? '\nEmail: ' + em : ''));
...
function hideLoading() { 
    if (payBtn) { payBtn.disabled = false; payBtn.innerHTML = '<i class="fas fa-lock"></i> Pay ₹5,999 + GST &amp; Get Analysis'; }
}
    ...
    form.addEventListener('submit', async function(e) {
        ...
        const options = {
            ...
            handler: function(response) {
                hideLoading();
                showResultModal(true, 'Payment Successful!', `Thank you ${fullName}! Your payment has been completed. Our team will contact you within 24 hours.`, response.razorpay_payment_id);
                form.reset();
            },
            modal: { 
                ondismiss: function() { 
...
// ─── Set minimum date for DOB if exists ────────────────────────────────────
