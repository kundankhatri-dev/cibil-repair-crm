...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_SERVER['HTTP_X_REQUESTED_WITH'])) {
    ...
    $service_id   = (int)($data['service_id'] ?? 6);
    $service_name = 'Profile Correction';
    $amount       = 3999;
...
<head>
  ...
  <meta name="description" content="Fix name mismatches, address errors, PAN card linking issues, and other personal information discrepancies on your CIBIL report. 98% success rate. Money-back guarantee.">
  <meta name="keywords" content="profile correction, CIBIL name correction, address correction, PAN linking, credit report profile update, personal information correction">
  <meta name="author" content="CIBIL Repair">
  <title>Profile Correction — Fix Name, Address &amp; PAN Mismatches | CIBIL Score Repair</title>
  <link rel="canonical" href="https://cibilrepair.in/service/profile">
  ...
  <!-- ============================================================
    ...
    <!-- ============================================================
     SCHEMA 4: SERVICE (PROFILE CORRECTION)
     ============================================================ -->
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Profile Correction — Quick Fix",
      "image": "https://cibilrepair.in/images/services/profile-correction.jpg",
      "description": "Fix name, PAN, address, and date of birth discrepancies across all four credit bureaus simultaneously using Aadhaar/PAN sync. Fast and permanent resolution in 15-20  days.",
      "provider": {
        "@type": "Organization",
        "name": "CIBIL Repair",
        "alternateName": ["CIBIL Repair India", "CIBIL"],
      ...
      "url": "https://cibilrepair.in/service/profile",
      "areaServed": "IN",
      ...
      "audience": {
        "@type": "Audience",
        "name": "Individuals with profile errors on their credit report"
      },
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://cibilrepair.in/service/profile"
      }
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "Profile Correction — Fix Name, Address & PAN Mismatches | CIBIL Repair",
      "description": "Fix name mismatches, address errors, PAN card linking issues, and other personal information discrepancies on your CIBIL report. 98% success rate. Money-back guarantee.",
      "url": "https://cibilrepair.in/service/profile",
      "mainEntity": {
        "@type": "Service",
        "name": "Profile Correction — Quick Fix",
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://cibilrepair.in/service/profile"
        }
      ]
    }
    </script>
    ...
    <!-- ============================================================
     SCHEMA 7: PRODUCT/OFFER (PROFILE CORRECTION)
     ============================================================ -->
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Product",
      "name": "Profile Correction — Quick Fix Service",
      "description": "Fix name, PAN, address, and date of birth discrepancies across all four credit bureaus simultaneously. Fast and permanent resolution in 15-20 days.",
      "image": "https://cibilrepair.in/images/services/profile-correction.jpg",
      "brand": {
        "@type": "Brand",
        "name": "CIBIL Repair"
...
<style>
/* ============================================================
   ROOT TOKENS — exact match with analysis.php / about-us.html
   ============================================================ */
:root{
...
/* ============================================================
   PAGE HERO — identical to analysis.php
   ============================================================ */
...
/* ============================================================
   WHAT WE FIX — 3-col cards (matching analysis.php check-grid)
   ============================================================ */
...
/* ============================================================
   PROCESS STEPS — dark (identical to analysis.php)
   ============================================================ */
...
.steps-grid::before{content:'';position:absolute;top:40px;left:10%;right:10%;height:2px;background:linear-gradient(90deg,var(--green),var(--blue2),var(--gold));z-index:0}
...
.step-title{font-family:'Montserrat',sans-serif;font-size:.85rem;font-weight:800;color:#fff;margin-bottom:8px}
.step-desc{font-size:.78rem;color:rgba(255,255,255,.5);line-height:1.65}
...
/* error types 2-col */
.error-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:12px;margin:20px 0 28px}
.error-item{display:flex;align-items:center;gap:12px;background:#fff8f0;padding:13px 16px;border-radius:12px;border-left:3px solid var(--orange);transition:.2s}
.error-item:hover{background:#fff0e0}
.error-item i{color:var(--orange);font-size:13px;flex-shrink:0;width:18px}
.error-item span{font-size:.875rem;color:var(--t1);font-weight:600}
...
/* ============================================================
   PAYMENT CARD — sticky right panel (matches analysis.php)
   ============================================================ */
...
/* ============================================================
   TRUST DARK SECTION (identical to analysis.php)
   ============================================================ */
...
/* ============================================================
   CTA SECTION (identical to analysis.php)
   ============================================================ */
...
/* ============================================================
   FOOTER (identical to analysis.php — with SVG logo)
   ============================================================ */
...
/* ============================================================
   MODALS (identical to analysis.php)
   ============================================================ */
...
<section class="page-hero">
  ...
  <div class="ph-inner">
    <div>
      <div class="ph-badge r"><div class="ph-dot"></div> Quick Fix — All 4 Bureaus</div>
      <h1 class="ph-h1 r">
        <span class="w">PROFILE</span>
        <span class="g">CORRECTION</span>
        <span class="y">QUICK FIX</span>
      </h1>
      <p class="ph-sub r">Name mismatches, wrong PAN, incorrect address, mismatched date of birth — all personal information discrepancies corrected simultaneously across CIBIL, Equifax, Experian &amp; CRIF within 15–20 days.</p>
      <div class="ph-acts r">
        <button class="btn-primary" onclick="document.getElementById('fullName').focus();document.getElementById('fullName').scrollIntoView({behavior:'smooth',block:'center'})">
          <i class="fas fa-user-edit"></i> Fix My Profile Now
        </button>
        <a href="#what-we-fix" class="btn-ghost"><i class="fas fa-arrow-down"></i> See What We Correct</a>
      </div>
      <div class="ph-trust r">
        <div class="pht"><span class="pht-n">98%</span><div class="pht-l">Success Rate</div></div>
        <div class="pht"><span class="pht-n">15–20</span><div class="pht-l">Day Resolution</div></div>
        <div class="pht"><span class="pht-n">4</span><div class="pht-l">Bureaus Updated</div></div>
        <div class="pht"><span class="pht-n">+40</span><div class="pht-l">Points Avg Gain</div></div>
      </div>
    </div>
    ...
    <div class="ph-card r">
      <div class="ph-card-header">
        ...
        <div class="ph-live">Fastest Fix</div>
      </div>
      <div class="milestones">
        <div class="ms"><div class="ms-icon g">👤</div><div class="ms-text"><div class="ms-title">Name Correction</div><div class="ms-sub">Spelling errors &amp; mismatches fixed</div></div><div class="ms-val g">All 4</div></div>
        <div class="ms"><div class="ms-icon y">🪪</div><div class="ms-text"><div class="ms-title">PAN &amp; Aadhaar Sync</div><div class="ms-sub">Cross-bureau identity alignment</div></div><div class="ms-val y">Verified</div></div>
        <div class="ms"><div class="ms-icon b">📍</div><div class="ms-text"><div class="ms-title">Address Correction</div><div class="ms-sub">Current address updated everywhere</div></div><div class="ms-val b">Updated</div></div>
        <div class="ms"><div class="ms-icon g">📅</div><div class="ms-text"><div class="ms-title">DOB &amp; Employer Fix</div><div class="ms-sub">All personal fields aligned</div></div><div class="ms-val g">15 Days</div></div>
      </div>
    </div>
  </div>
</section>
...
<div class="breadcrumb-bar">
  <div class="bc-inner">
    ...
    <span>›</span>
    <span class="current">Profile Correction</span>
  </div>
</div>
...
<div class="stats-band">
  <div class="sb-grid">
    <div class="sb-item r"><span class="sb-num gold" data-target="35" data-s="%">0</span><div class="sb-desc">Reports Have Profile Errors</div></div>
    <div class="sb-item r"><span class="sb-num green" data-target="40" data-s=" pts">0</span><div class="sb-desc">Avg Score Improvement</div></div>
    <div class="sb-item r"><span class="sb-num blue" data-target="15" data-s=" Days">0</span><div class="sb-desc">Fastest Resolution</div></div>
...
<section class="process-sec">
  <div class="W">
    <div class="sh r">
      ...
      <h2 class="st" style="color:#fff">Our <em>Correction Process</em></h2>
      <p class="ss" style="color:rgba(255,255,255,.5)">Five expert-led steps from error identification to verified correction across all four bureaus.</p>
    </div>
    <div class="steps-grid">
      <div class="step-card r">
        <div class="step-num-wrap"><i class="fas fa-download"></i></div>
        <div class="step-title">Obtain Your Reports</div>
        <p class="step-desc">We guide you to download your reports from all 4 bureaus — free annual reports, no extra cost.</p>
      </div>
      <div class="step-card r">
        <div class="step-num-wrap" style="background:linear-gradient(135deg,var(--blue),var(--blue2))"><i class="fas fa-search"></i></div>
        <div class="step-title">Identify Discrepancies</div>
        <p class="step-desc">Our experts compare every field against your PAN, Aadhaar &amp; Passport to flag all mismatches.</p>
      </div>
      <div class="step-card r">
        <div class="step-num-wrap" style="background:linear-gradient(135deg,#d97706,var(--gold2))"><i class="fas fa-file-alt"></i></div>
        <div class="step-title">Draft Correction Requests</div>
        <p class="step-desc">Bureau-specific dispute letters prepared with supporting documents — nothing is missed.</p>
      </div>
      <div class="step-card r">
        <div class="step-num-wrap"><i class="fas fa-paper-plane"></i></div>
        <div class="step-title">File &amp; Follow Up</div>
        <p class="step-desc">Disputes submitted online and by mail to each bureau simultaneously. We track and escalate daily.</p>
      </div>
      <div class="step-card r">
        ...
        <p class="step-desc">Updated reports confirmed, corrections verified, and a summary sent directly to you.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="sec" id="what-we-fix">
  <div class="W">
    <div class="sh r">
      <div class="pill pill-green">✅ Correction Scope</div>
      <h2 class="st">What We <em>Fix</em></h2>
      <p class="ss">Every personal information field corrected across all four bureaus simultaneously — nothing slips through.</p>
    </div>
    <div class="check-grid" style="margin-bottom:80px">
      <div class="ck r">
        <div class="ck-icon">👤</div>
        <div class="ck-name">Name Corrections</div>
        <p class="ck-desc">Spelling errors, nickname mismatches, and inconsistencies between your report and PAN/Aadhaar that cause profile mix-ups.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">🪪</div>
        <div class="ck-name">PAN Card Linking &amp; Fix</div>
        <p class="ck-desc">Wrong PAN number, unlinked PAN, or duplicate PAN entries causing your score to reflect someone else's history.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">📍</div>
        <div class="ck-name">Address Discrepancies</div>
        <p class="ck-desc">Outdated or incorrect address fields that trigger lender red flags during address verification checks.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">📅</div>
        <div class="ck-name">Date of Birth Errors</div>
        <p class="ck-desc">Wrong DOB on your credit report can merge your profile with another person's — a critical fix for loan eligibility.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">📱</div>
        <div class="ck-name">Phone &amp; Email Updates</div>
        <p class="ck-desc">Incorrect mobile numbers and email IDs prevent OTP delivery during loan applications, causing silent rejections.</p>
      </div>
      <div class="ck r">
        <div class="ck-icon">🏢</div>
        <div class="ck-name">Employer &amp; Income Fields</div>
        <p class="ck-desc">Wrong employer name or income category reduces credit limit eligibility and triggers lender verification failures.</p>
      </div>
    </div>
    ...
    <div class="service-layout">
      <div class="service-content">
        ...
        <h2>📖 What is Profile Correction?</h2>
        <p>Your credit report contains personal identifiers — name, date of birth, PAN, address, phone number — used by every lender to verify your identity. Even a single character mismatch (e.g., "Rajesh Kumar" vs "Rajesh K") can merge your profile with someone else's credit history, pull their defaults onto your record, or trigger automatic application rejection.</p>
        <p>Profile correction ensures every bureau holds exactly the same, accurate information as on your official documents (PAN, Aadhaar, Passport). It is the fastest way to remove unfair score damage — and one of the most commonly overlooked fixes.</p>

        <div class="inline-stats">
          <div class="istat r"><span class="istat-n">35%</span><div class="istat-l">Reports have personal info errors</div></div>
          <div class="istat r"><span class="istat-n">+40 pts</span><div class="istat-l">Avg score gain after fix</div></div>
          <div class="istat r"><span class="istat-n">15 Days</span><div class="istat-l">Fastest resolution in India</div></div>
        </div>

        <h2>🔍 Common Profile Errors We Fix</h2>
        <div class="error-grid">
          <div class="error-item"><i class="fas fa-user"></i><span>Name spelling mismatch</span></div>
          <div class="error-item"><i class="fas fa-map-marker-alt"></i><span>Incorrect / outdated address</span></div>
          <div class="error-item"><i class="fas fa-calendar-alt"></i><span>Wrong date of birth</span></div>
          <div class="error-item"><i class="fas fa-id-card"></i><span>PAN card not linked or mismatched</span></div>
          <div class="error-item"><i class="fas fa-fingerprint"></i><span>Aadhaar number errors</span></div>
          <div class="error-item"><i class="fas fa-phone-alt"></i><span>Wrong mobile number on file</span></div>
          <div class="error-item"><i class="fas fa-envelope"></i><span>Incorrect email ID</span></div>
          <div class="error-item"><i class="fas fa-building"></i><span>Employer name mismatch</span></div>
        </div>

        <h2>🎯 What You Receive</h2>
        <p>Our profile correction service is a complete end-to-end fix — not just a dispute letter:</p>
        <ul class="report-list">
          <li><span>✅</span> Corrections applied across all 4 bureaus simultaneously</li>
          <li><span>📝</span> Bureau-specific dispute letters filed on your behalf</li>
          <li><span>🔄</span> Bank escalation &amp; ombudsman filing if bureau refuses</li>
          <li><span>📋</span> Updated credit reports confirming all corrections</li>
          <li><span>📞</span> Expert support via WhatsApp &amp; email for 60 days</li>
          <li><span>💰</span> 100% money-back if corrections cannot be made</li>
        </ul>

        <h2>✅ Benefits of Fixing Your Profile</h2>
        <div class="benefits-grid">
          <div class="benefit-item"><strong>🛡️ Stop Identity Mix-up</strong><span>Prevent someone else's bad credit from appearing on your report</span></div>
          <div class="benefit-item"><strong>📈 Score Improvement</strong><span>Removing wrongly mapped defaults can boost your score 20–50 points</span></div>
          <div class="benefit-item"><strong>⚡ Faster Loan Approvals</strong><span>Lenders auto-reject mismatched profiles — correction removes that block</span></div>
          <div class="benefit-item"><strong>🔒 Permanent Fix</strong><span>Once corrected, bureaus update their records and the right profile stays</span></div>
          <div class="benefit-item"><strong>🏦 Better Interest Rates</strong><span>Accurate identity helps you qualify for lower rates and higher limits</span></div>
          <div class="benefit-item"><strong>📊 True Credit History</strong><span>Your report will finally reflect only YOUR financial behaviour</span></div>
        </div>

        <h2>❓ Frequently Asked Questions</h2>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">How long does profile correction take? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">Most cases are resolved in 15–20 working days. Each bureau is required by law to respond to disputes within 30 days. We file simultaneously and follow up daily to get results faster than doing it yourself.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">Can a wrong PAN number on my report be corrected? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">Absolutely. We submit a certified copy of your PAN card and a formal written request to each bureau. This is one of the most common errors our team resolves — and one of the easiest when handled properly with the right documentation.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">What if the bank refuses to update my information? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">We escalate to the Banking Ombudsman and RBI Consumer Education &amp; Protection Department. Our legal team ensures your rights under the Credit Information Companies (Regulation) Act, 2005 are fully enforced.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">What documents do I need to provide? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">Typically your PAN card, Aadhaar card, and any supporting proof of the correct information (utility bill for address, birth certificate for DOB). Our team will specify exactly what's needed for your case — nothing extra is requested.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">Will my score improve after the correction? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">Yes. Once the correct profile is updated, any negative entries that were incorrectly mapped from another person's record are removed. Most clients see an improvement of 20–50 points, with some cases gaining significantly more when a full profile mix-up is resolved.</div>
        </div>
        <div class="faq-item" onclick="this.classList.toggle('active')">
          <div class="faq-question">Is my data safe with CIBIL Repair? <i class="fas fa-chevron-down"></i></div>
          <div class="faq-answer">Yes, absolutely. All data is encrypted with 256-bit SSL and we are fully compliant with the IT Act 2000 and DPDP Act 2023. Your documents are never shared with third parties or sold under any circumstances.</div>
        </div>
      ...
      <div>
        <div class="payment-card r">
          <div class="price-badge">
            <div class="price">₹3,999 <small>+ GST</small></div>
            <div class="gst-note">18% GST applicable — total ₹4,719</div>
            <span class="save-tag">⚡ Fastest Fix — Results in 15 Days</span>
          </div>

          <ul class="features-list">
            <li><i class="fas fa-check-circle"></i> Complete 4-bureau profile audit</li>
            <li><i class="fas fa-check-circle"></i> Name &amp; spelling correction</li>
            <li><i class="fas fa-check-circle"></i> Address &amp; DOB correction</li>
            <li><i class="fas fa-check-circle"></i> PAN card linking &amp; fix</li>
            <li><i class="fas fa-check-circle"></i> Aadhaar verification support</li>
            <li><i class="fas fa-check-circle"></i> Dispute filing with all 4 bureaus</li>
            <li><i class="fas fa-check-circle"></i> Bank escalation &amp; follow-up</li>
            <li><i class="fas fa-check-circle"></i> Updated report confirmation</li>
          ...
          <form id="paymentForm">
            ...
            <button type="submit" class="pay-btn" id="payBtn">
              <i class="fas fa-lock"></i> Pay ₹3,999 + GST &amp; Fix My Profile
            </button>
          </form>
...
<section class="trust-sec">
  <div class="W">
    ...
    <div class="trust-grid">
      <div class="trust-card r"><div class="tci g">⚖️</div><h4>RBI Compliant</h4><p>All dispute processes strictly follow Reserve Bank of India guidelines and Indian consumer protection law.</p></div>
      ...
      <div class="trust-card r"><div class="tci g">🏦</div><h4>All 4 Bureaus</h4><p>We file corrections simultaneously with CIBIL, Equifax, Experian, and CRIF — no bureau is skipped.</p></div>
      <div class="trust-card r"><div class="tci y">💰</div><h4>Money-Back Guarantee</h4><p>If we can't correct the agreed profile errors, you receive a full refund — no questions asked.</p></div>
...
<section class="cta-sec">
  <div class="W">
    <div class="cta-inner r">
      <h2 class="cta-h">Have a Name or Address Mismatch on Your <em>CIBIL Report?</em></h2>
      <p class="cta-p">Talk to our profile correction expert before you pay anything. Free guidance, no obligation — just real answers about your specific case.</p>
      <div class="cta-acts">
        <button class="btn-primary" onclick="openModal()"><i class="fas fa-rocket"></i> Get Free Consultation</button>
        <a href="https://wa.me/919905482503?text=Hi%2C%20I%20need%20help%20with%20profile%20correction%20on%20my%20CIBIL%20report" class="btn-ghost" target="_blank"><i class="fab fa-whatsapp"></i> Chat on WhatsApp</a>
      ...
      <div class="cta-trust">
        ...
        <div class="ct"><i class="fas fa-check-circle"></i> Fix in 15–20 working days</div>
      </div>
    </div>
  </div>
</section>
...
<!-- ============================================================
     FOOTER — SVG logo (matches analysis.php)
     ============================================================ -->
<footer>
  <div class="W">
    <div class="fg">
...
<!-- WhatsApp FAB -->
<a href="https://wa.me/919905482503?text=Hi%2C%20I%20need%20help%20with%20profile%20correction%20on%20my%20CIBIL%20report" class="wa" target="_blank" aria-label="WhatsApp"><i class="fab fa-whatsapp"></i></a>

<!-- FREE CONSULTATION MODAL (identical to analysis.php) -->
<div class="modal-bg" id="modal">
  <div class="modal-box">
    <button class="mc" onclick="closeModal()">×</button>
    <span class="m-ico">🎯</span>
    <h3 class="m-h">Free Profile Consultation</h3>
    <p class="m-s">Get expert advice on fixing your credit profile. Our team contacts you within 2 hours.</p>
...
const SERVICE = { id: 6, name: 'Profile Correction', amount: 3999, caseNo: 'PRF' + Date.now() };
...
function submitLead() {
    ...
    const msg = encodeURIComponent('Hi! I want a free CIBIL profile correction consultation.\n\nName: ' + n + '\nPhone: ' + p + (em ? '\nEmail: ' + em : ''));
...
function hideLoading() { 
    if (payBtn) { payBtn.disabled = false; payBtn.innerHTML = '<i class="fas fa-lock"></i> Pay ₹3,999 + GST &amp; Fix My Profile'; }
}
    ...
    form.addEventListener('submit', async function(e) {
        ...
        const options = {
            ...
            handler: function(response) {
                hideLoading();
                showResultModal(true, 'Payment Successful!', `Thank you ${fullName}! Your payment has been completed. Our team will contact you within 24 hours to begin your profile correction.`, response.razorpay_payment_id);
                form.reset();
            },
            modal: { 
                ondismiss: function() { 
