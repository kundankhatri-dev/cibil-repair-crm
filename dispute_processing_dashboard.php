...
$allowed_roles = ["credit_analyst,operations_manager,admin,super_admin"];
...
<head>
    ...
    <title>Dispute Processing Dashboard</h1>
            <div>
        ...
        <div class="card">
            <div class="card-title">Welcome to Dispute Processing Dashboard</div>
