...
$allowed_roles = ["manager,compliance_officer,admin,super_admin"];
...
<head>
    ...
    <title>Document Management Dashboard</h1>
            <div>
        ...
        <div class="card">
            <div class="card-title">Welcome to Document Management Dashboard</div>
