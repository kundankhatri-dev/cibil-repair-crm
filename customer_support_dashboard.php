...
$allowed_roles = ["support_agent,support_manager,admin,super_admin"];
...
<head>
    ...
    <title>Customer Support Dashboard</h1>
            <div>
        ...
        <div class="card">
            <div class="card-title">Welcome to Customer Support Dashboard</div>
