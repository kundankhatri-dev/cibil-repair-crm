...
if (isset($_GET['api_action'])) {
    ...
    try {
        ...
        if ($action === 'get_dashboard_stats') {
            ...
            $table_check = $pdo->query("SHOW TABLES LIKE 'disputes'");
            if ($table_check->rowCount() == 0) {
                echo json_encode([
                    ...
                    'status_flow' => '<div class="empty-state"><i class="fas fa-gavel"></i><p>No disputes table found. Please run the SQL setup.</p></div>',
